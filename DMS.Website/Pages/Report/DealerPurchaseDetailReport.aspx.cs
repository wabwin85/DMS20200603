...
{
    public partial class DealerPurchaseDetailReport : BasePage
    {
        ...
        private void RefreshData(int start, int limit)
        {
            ...
            DataTable query = _businessReport.DealerPurchaseDetailReport(GetQueryList(), (start == -1 ? 0 : start), (limit == -1 ? this.PagingToolBar1.PageSize : limit), out totalCount).Tables[0];
        ...
        {
            DataTable dt = _businessReport.ExportDealerPurchaseDetailReport(GetQueryList()).Tables[0];
