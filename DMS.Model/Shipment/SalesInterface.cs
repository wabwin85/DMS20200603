...
namespace DMS.Model
{
	...
	/// </summary>
	[Serializable]
	public class SalesInterface : BaseModel
	{
		...
		private string _sph_shipmentnbr; 
		...
		/// 销售单号
		/// </summary>		
		public string SphShipmentNbr
		{
			get { return _sph_shipmentnbr; }
			set	
			{
				if( value!= null && value.Length > 30)
					throw new ArgumentOutOfRangeException("Invalid value for SphShipmentNbr", value, value.ToString());
				
				_sph_shipmentnbr = value;
			}
		}
