...
Values('Menu',2,'销售岗位与医院',68,0,'~/Revolution/Pages/MasterDatas/PositionHospital.aspx',
1,'M2_PositionHospital',90,'admin',GetDate())
...
Values(newid(),(Select PowerKey From lafite_sitemap WHERE MenuType='Menu' AND MenuTitle='销售岗位与医院'),
'销售岗位与医院','',0,'','Menu',1,'4028931b0f0fc135010f0fc1356a0001',0,'admin',GetDate(),
'admin',GetDate())
...
Values(newid(),'','','销售岗位与医院',1,'','4028931b0f0fc135010f0fc1356a0001',0,
...
Values(newid(),(Select id from lafite_STRATEGY where strategy_name='销售岗位与医院'),
'Function',(select id from Lafite_Function where Function_Name='销售岗位与医院'),0,
...
,'STRATEGY',(Select id from lafite_STRATEGY where strategy_name='销售岗位与医院'),
