...
/****** Object:  StoredProcedure [Workflow].[Proc_Contract_RenewalLp_GetHtmlData]    Script Date: 2019/11/22 14:19:51 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT 'Contract_RenewalLp' AS TemplateName,
	       'Main,Current,Proposals,Ncm,Justification,PreContract,Quota,Service,Kpi,Cfda,Qualification,Display,DDReport' AS 
	       TableNames
