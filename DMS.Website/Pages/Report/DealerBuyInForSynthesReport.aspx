<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerBuyInForSynthesReport.aspx.cs" Inherits="DMS.Website.Pages.Report.DealerBuyInForSynthesReport" %>
...
//        var OrderStartDate = <%=txtOrderStartDate.ClientID%>.getValue();
//        if (OrderStartDate == "")
//        {
//            alert('<%=GetLocalResourceObject("CheckCondition.OrderStartDate.Alert").ToString()%>');
//            return false;
//        }
//        
//        var OrderEndDate = <%=txtOrderEndDate.ClientID%>.getValue();
//        if (OrderEndDate == "")
//        {
//            alert('<%=GetLocalResourceObject("CheckCondition.OrderEndDate.Alert").ToString()%>');
//            return false;
//        }
//        
//       
...
//        {
//            alert('<%=GetLocalResourceObject("CheckCondition.OrderEarlier.Alert").ToString()%>');
//            return false;
//        }
//        
//        var r = OrderStartDate.DateAdd("m", 3);
//        if(r <= OrderEndDate)
//        {
//            alert('<%=GetLocalResourceObject("CheckCondition.OrderRange.Alert").ToString()%>');
//            return false;
//        }
                                    ...
                                    <ext:Panel ID="Panel3" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="120">
                                                ...
                                                <ext:Anchor>
                                                    <ext:DateField ID="txtOrderStartDate" runat="server" Width="150" FieldLabel="<%$ Resources: Panel1.FormLayout1.txtOrderStartDate.FieldLabel %>" />
                                                </ext:Anchor>
                                                <ext:Anchor>
                                    ...
                                    <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="120">
                                                ...
                                                <ext:Anchor>
                                                    <ext:DateField ID="txtOrderEndDate" runat="server" Width="150" FieldLabel="<%$ Resources: Panel1.FormLayout2.txtOrderEndDate.FieldLabel %>" />
                                                </ext:Anchor>
                                                <ext:Anchor>
