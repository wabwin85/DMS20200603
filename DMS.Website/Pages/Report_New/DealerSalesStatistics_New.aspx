<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="DealerSalesStatistics_New.aspx.cs" Inherits="DMS.Website.Pages.Report_New.DealerSalesStatistics_New" %>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryInDueTime" class="FrameControl"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    <div class="col-xs-4 col-label">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryIsPurchased" class="FrameControl"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/DealerSalesStatistics_New.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            DealerSalesStatistics_New.Init();
        });
    </script>
</asp:Content>
