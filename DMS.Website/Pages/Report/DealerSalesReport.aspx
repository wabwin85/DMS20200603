<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerSalesReport.aspx.cs"
    Inherits="DMS.Website.Pages.Report.DealerSalesReport" %>
                                    ...
                                    <ext:Panel ID="Panel2" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="80">
                                                ...
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbStatus" runat="server" EmptyText="选择单据状态" Width="150"
