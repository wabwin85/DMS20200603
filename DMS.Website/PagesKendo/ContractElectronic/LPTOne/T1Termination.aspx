<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageKendo/Site.Master" AutoEventWireup="true" CodeBehind="T1Termination.aspx.cs" Inherits="DMS.Website.Pages.ContractKendo.LPTOne.T1Termination" %>
                            ...
                            <div class="panel-body" id="PnlContractContent">
                                <table style="width: 100%;" class="KendoTable">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 15%;">
                                            <div id="DealerManager" class="FrameControl"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 10%;"><i class='fa fa-blank'></i>&nbsp;申请人中文名</td>
                                        <td style="width: 15%;">
                                            <div id="ApplicantName" class="FrameControl invalid"></div>
                                        </td>
                                        <td style="width: 10%;"><i class='fa fa-blank'></i>&nbsp;申请人英文名</td>
                                        <td style="width: 15%;">
                                            <div id="ApplicantNameEn" class="FrameControl invalid"></div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 15%;">
                                            <div id="TerminationType" class="FrameControl"></div>
                                        </td>
                                        <td style="width: 10%;"><i class='fa fa-blank'></i>&nbsp;应付款项</td>
                                        <td style="width: 15%;">
                                            <div id="Balance" class="FrameControl"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript" src="../script/T1Termination.js"></script>
    <script>
