<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="MasterDatasList.aspx.cs" Inherits="DMS.Website.Revolution.Pages.MasterDatas.MasterDatasList" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script src="Script/MasterDatasList.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    < <script type="text/javascript">
        $(document).ready(function () {
            MasterDatasList.Init();
        });
    </script>
</asp:Content>