<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryReturnImportConsignment.aspx.cs" Inherits="DMS.Website.Pages.Inventory.InventoryReturnImportConsignment" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var editControls = [
                          ...
                          { name: 'PurchaseOrderNbr', field: {xtype:"textfield",width:160,maxLength:50,allowBlank:false} },
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_ReturnConsignment.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: GridPanel3.Title %>" StoreID="ResultStore" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="Warehouse" DataIndex="Warehouse" Header="仓库名称" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="PurchaseOrderNbr" DataIndex="PurchaseOrderNbr" Header="<%$ Resources: GridPanel3.ColumnModel3.OrderNo.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
