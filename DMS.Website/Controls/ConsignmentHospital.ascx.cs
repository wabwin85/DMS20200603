...
namespace DMS.Website.Controls
{
    ...
    using System.Data;
    using DMS.Website.Pages.Consignment;

    [AjaxMethodProxyID(IDMode = AjaxMethodProxyIDMode.Alias, Alias = "ConsignmentHospital")]
    public partial class ConsignmentHospital : BaseUserControl
    {
