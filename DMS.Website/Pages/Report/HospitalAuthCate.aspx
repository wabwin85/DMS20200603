<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HospitalAuthCate.aspx.cs" Inherits="DMS.Website.Pages.Report.HospitalAuthCate" %>
                                    ...
                                    <ext:Panel ID="Panel2" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:TextField ID="tfHosName" runat="server" FieldLabel="<%$ Resources: Panel2.FormLayout1.tfHosName.FieldLabel %>" ></ext:TextField>
                                                </ext:Anchor>
                                            </ext:FormLayout>
                                        </Body>
                                    </ext:Panel>
