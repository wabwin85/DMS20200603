DROP view [interface].[V_I_QV_DealerInventory_Backup201409]
GO
...
CREATE view [interface].[V_I_QV_DealerInventory_Backup201409]
as
--是否需要过滤停用经销商的库存
select * from (
		select	
  ...
  FROM interface.V_I_CR_Inventory_Backup201409 i
