...
{
    public partial class SalesHospitalReport : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_SalesHospitalReport;
        ...
        protected void btnSearch_Click(object sender, AjaxEventArgs e)
        {
            ...
            parametrts[1] = new ReportParameter("UserId", _context.User.Id, false);
