<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SampleApplyApproval.aspx.cs" Inherits="DMS.Website.Pages.SampleManage.SampleApplyApproval" %>
                        ...
                        <ext:Panel ID="Panel2" runat="server" Header="false" BodyStyle="padding: 5px;" AutoScroll="true">
                                        ...
                                        <ext:Panel ID="Panel6" runat="server" Header="false" Frame="false" BodyBorder="false"
                                            ...
                                            <Body>
                                                <div style="text-align: center; font-size: medium; font-family: 微软雅黑;">
                                                    <asp:Literal ID="Literal1" runat="server" Text="样品申请单" />
                                                </div>
                                            </Body>
                                        </ext:Panel>
                                    </ext:LayoutRow>
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="Button1" runat="server" Text="返回" Icon="Cancel">
                                    <Listeners>
                                        <Click Handler="if(getIsEkpAccess()=='FASE'){window.close();} else{window.location.href ='/Pages/SampleManage/SampleApplyList.aspx'}" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:Panel>
