<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryAdjustAuditImport.aspx.cs" Inherits="DMS.Website.Pages.Inventory.InventoryAdjustAuditImport" %>

<%@ Register Assembly="Coolite.Ext.Web" Namespace="Coolite.Ext.Web" TagPrefix="ext" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>审批结果批量上传</title>
            ...
            <Body>
                <ext:BorderLayout ID="BorderLayout1" runat="server">
                    <North MarginsSummary="5 5 5 5" Collapsible="true">
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="审批结果批量上传"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="下载模板">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_LPRLD_T2ReturnConfirm.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="列表" StoreID="ResultStore" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="ErrorMsg" DataIndex="ErrorMsg" Width="250px"
                                                    Header="错误信息" Sortable="false">
                                                    <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="ReturnNo" DataIndex="ReturnNo" Header="退货单编号" Sortable="false">
                                                </ext:Column>
                                                <ext:Column ColumnID="ConfirmDate" DataIndex="ConfirmDate" Header="确认退货日期"
                                                    Sortable="false" Width="100px">
                                                </ext:Column>
                                                <ext:Column ColumnID="LotNumber" DataIndex="LotNumber" Header="产品UPN"
                                                    Sortable="false" Width="150px">
                                                </ext:Column>
                                                <ext:Column ColumnID="QrCode" DataIndex="QrCode" Header="二维码"
                                                    Sortable="false" Width="150px">
                                                </ext:Column>
                                                <ext:Column ColumnID="IsConfirm" DataIndex="IsConfirm" Header="是否确认" Sortable="false"
                                                    Width="150px">
                                                </ext:Column>
                                                <ext:Column ColumnID="Price" DataIndex="Price" Header="确认退货产品价格（含税单价）" Sortable="false"
                                                    Width="150px">
                                                </ext:Column>
                                                <ext:Column ColumnID="Remark" DataIndex="Remark" Header="备注" Sortable="false">
                                                </ext:Column>
