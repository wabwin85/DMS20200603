USE [GenesisDMS_PRD]
GO
/****** Object:  StoredProcedure [Workflow].[Proc_Contract_RenewalT2_GetHtmlData]    Script Date: 2019/12/10 11:33:12 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT 'Contract_RenewalT2' AS TemplateName,
	       'Main,Current,Proposals,NCM,KPI,Cfda,Qualification,Display,DDReport,TrainInfo' AS TableNames
