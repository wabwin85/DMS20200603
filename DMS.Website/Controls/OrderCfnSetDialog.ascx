<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrderCfnSetDialog.ascx.cs" Inherits="DMS.Website.Controls.OrderCfnSetDialog" %>
    ...
    var addCfnSet = function (grid) {
        ...
        if (list.length > 0) {
            Ext.Msg.confirm('Message', '<%=GetLocalResourceObject("addCfnSet.confirm.Body").ToString()%>',
                function (e) {
                    if (e == 'yes') {
                        Coolite.AjaxMethods.OrderCfnSetDialog.DoAddCfnSet(list,
                            {
                                success: function () {
...
<ext:Window ID="CfnSetWindow" runat="server" Icon="Group" Title="<%$ Resources: CfnSetWindow.Title %>"
    Width="800" Height="600" AutoShow="false" Modal="true" ShowOnLoad="false" BodyStyle="padding:5px;" Resizable="false" Header="false">
    <Body>
