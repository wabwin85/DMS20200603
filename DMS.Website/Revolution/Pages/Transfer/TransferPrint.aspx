<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferPrint.aspx.cs"
    Inherits="DMS.Website.Revolution.Pages.Transfer.TransferPrint" %>
...
<body>
    ...
    <div align="center" >
        ...
        <p>
            &nbsp;</p>
        <table style="margin-bottom: 20px; border-collapse: collapse; border: none; vertical-align: top;
            border-color: White;" width="700px" cellspacing="0px" cellpadding="0px">
            <tr>
                ...
                <td>
                    <table border="1" cellpadding="0" cellspacing="0" style="height: 88px; width: 700px;
                        ...
                        <tr align="left" style="border-color: Black; border-style: inherit;">
                            ...
                            <td class="style3">
                                <%=GetLocalResourceObject("form1.table.tr.td1").ToString()%><asp:Label ID="tbTransferNumber"
                                    runat="server"></asp:Label>
                            </td>
                            <td class="style1">
                        ...
                        <asp:GridView ID="GridView1" runat="server" EmptyDataText="<%$ Resources: GridView1.EmptyDataText %>"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="<%$ Resources: GridView1.Columns.HeaderText %>">
                                    <ItemTemplate>
                                        <asp:Label ID="label1" runat="server" Width="70" Text='<% #Eval("WarehouseName")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText='<%$ Resources: resource,Lable_Article_Number  %>'>
                                    <ItemTemplate>
                                        <asp:Label ID="label2" runat="server" Width="80" Text='<% #Eval("CFN")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="产品名称" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblCFNChineseName" runat="server" Width="120" Text='<% #Eval("CFNChineseName")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="产品批号">
                                    <ItemTemplate>
                                        <asp:Label ID="label4" runat="server" Width="70" Text='<% #Eval("LotNumber")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: GridView1.Columns.HeaderTextRegistration %>">
                                    <ItemTemplate>
                                        <asp:Label ID="label4" runat="server" Width="100" Text='<% #Eval("Registration")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: GridView1.Columns.HeaderText3 %>">
                                    <ItemTemplate>
                                        <asp:Label ID="label5" runat="server" Width="60" Text='<% #Eval("ExpiredDate")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources: GridView1.Columns.HeaderText5 %>">
                                    <ItemTemplate>
                                        <asp:Label ID="label8" runat="server" Width="30" Text='<% #Eval("TransferQty")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources: GridView1.Columns.HeaderText6 %>">
                                    <ItemTemplate>
                                        <asp:Label ID="label9" runat="server" Width="70" Text='<% #Eval("ToWarehouseName")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
