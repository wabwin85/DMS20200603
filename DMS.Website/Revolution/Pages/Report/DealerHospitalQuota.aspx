<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="DealerHospitalQuota.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Report.DealerHospitalQuota" %>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-buttom" id="PnlButton">
                                    <a id="BtnQuery"></a>
                                    <a id="BtnExportDealerHospitalQuota"></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/DealerHospitalQuota.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            DealerHospitalQuota.Init();
        });
    </script>
</asp:Content>
