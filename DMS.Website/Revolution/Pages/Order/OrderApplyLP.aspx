<%@ Page Title="平台及一级经销商订单申请" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="OrderApplyLP.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Order.OrderApplyLP" %>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-buttom" id="PnlButton">
                                    ...
                                    <a id="BtnImport"></a>
                                    <a id="BtnEptLog"></a>
                                    <a id="BtnExpInvoice"></a>
                                    <a id="BtnExpDetail"></a>
                                    <a id="BtnStockprice"></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/OrderApplyLP.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
