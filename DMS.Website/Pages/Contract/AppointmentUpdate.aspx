<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppointmentUpdate.aspx.cs" Inherits="DMS.Website.Pages.Contract.AppointmentUpdate" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            var ProductAllWindow = function () {
                ...
                var effectivedate = Ext.getCmp('<%=this.dfAgreementBegin.ClientID%>')
                ...
                if (massage == "") {
                    Coolite.AjaxMethods.TerritoryEditorAdmin.Show(contractId.getValue(), updateId.getValue(), 'Appointment', subbucode.getValue(), effectivedate.getValue(), companyId.getValue(), productline.getText(), { success: function () { }, failure: function (err) { Ext.Msg.alert('Error', err); } });
                }
                else {
            ...
            var UpdateAOPWindow = function () {
                ...
                if (massage == "") {
                    Coolite.AjaxMethods.AopEditorAdmin.Show(contractId.getValue(), updateId.getValue(), 'Appointment', subbucode.getValue(), effectivedate.getValue(), companyId.getValue(), productline.getText(), { success: function () { }, failure: function (err) { Ext.Msg.alert('Error', err); } });
                }
                else {
                    //Ext.Msg.alert('Error', massage);
                    Ext.Msg.alert('Error', '信息不完整，不能维护授权！');
                                        ...
                                        <ext:Panel ID="Panel6" runat="server" Header="false" Frame="false" BodyBorder="false"
                                            ...
                                            <Body>
                                                <div style="text-align: center; font-size: medium; font-family: 微软雅黑;">
                                                    <asp:Literal ID="Literal1" runat="server" Text="新经销商申请合同修改" />
                                                </div>
                                            </Body>
                                        </ext:Panel>
                                    </ext:LayoutRow>
                                        ...
                                        <ext:FieldSet ID="FieldSetMain" runat="server" Frame="false" BodyBorder="true" AutoHeight="true" Title="合同明细">
                                            <Body>
                                                <ext:FormLayout runat="server">
                                                                        ...
                                                                        <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="120">
                                                                                    <ext:Anchor>
                                                                                        <ext:RadioGroup ID="rgReason" runat="server" FieldLabel="申请原因" Width="250">
                                                                                            <Items>
                                                                                                <ext:Radio ID="rgReason1" runat="server" BoxLabel="新经销商" />
                                                                                                <ext:Radio ID="rgReason2" runat="server" BoxLabel="一级转二级" />
                                                                                                <ext:Radio ID="rgReason3" runat="server" BoxLabel="二级转一级 " />
                                                                                                <ext:Radio ID="rgReason4" runat="server" BoxLabel="更换经营实体 " />
                                                                                            </Items>
                                                                                        </ext:RadioGroup>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:ComboBox ID="cbAssessment" runat="server" EmptyText="请选择经销商名称..." Width="200" Editable="true"
                                                                        ...
                                                                        <ext:Panel ID="Panel5" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="120">
                                                                                    <ext:Anchor>
                                                                                        <ext:ComboBox ID="cbFormeRname" runat="server" EmptyText="请选择经销商名称..." Width="200" Editable="true"
                                                                                            TypeAhead="true" StoreID="DealerStore" ValueField="SapCode" DisplayField="ChineseShortName"
                                                                                            Mode="Local" FieldLabel="曾用名" ListWidth="300" Resizable="true">
                                                                                            <Triggers>
                                                                                                <ext:FieldTrigger Icon="Clear" Qtip="清除" />
                                                                                            </Triggers>
                                                                                            <Listeners>
                                                    ...
                                                    <%--新经销商基本信息--%>
                                                    <ext:Anchor>
                                                        <ext:Panel ID="Panel7" runat="server" Header="true" Title="新经销商基本信息 " BodyStyle="padding: 5px;" FormGroup="true">
                                                            <Body>
                                                                <ext:ColumnLayout ID="ColumnLayout6" runat="server">
                                                                        ...
                                                                        <ext:Panel ID="Panel15" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout4" runat="server" LabelAlign="Left" LabelWidth="150">
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfCompanyName" runat="server" FieldLabel="公司中文名称" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfContact" runat="server" FieldLabel="联系人" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfOfficeNumber" runat="server" FieldLabel="办公室电话号码" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfEstablishedTime" runat="server" FieldLabel="公司成立日期" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfLPSAPCode" runat="server" FieldLabel="上级平台" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfOfficeAddress" runat="server" FieldLabel="办公地址" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                </ext:FormLayout>
                                                                            </Body>
                                                                    ...
                                                                    <ext:LayoutColumn ColumnWidth=".33">
                                                                        <ext:Panel ID="Panel16" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout10" runat="server" LabelAlign="Left" LabelWidth="150">
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfCompanyEName" runat="server" FieldLabel="公司英文名称" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfEMail" runat="server" FieldLabel="邮件地址" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfMobile" runat="server" FieldLabel="手机号码" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfCapital" runat="server" FieldLabel="公司注册资本" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                </ext:FormLayout>
                                                                            </Body>
                                                                    ...
                                                                    <ext:LayoutColumn ColumnWidth=".34">
                                                                        <ext:Panel ID="Panel17" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout11" runat="server" LabelAlign="Left" LabelWidth="150">
                                                                                    <ext:Anchor>
                                                                                        <ext:Label runat="server" ID="lbSAPCode" FieldLabel="ERP Code"></ext:Label>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                    ...
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfCompanyType" runat="server" FieldLabel="企业类型" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                                        <ext:TextField ID="tfWebsite" runat="server" FieldLabel="公司网站" Width="250">
                                                                                        </ext:TextField>
                                                                                    </ext:Anchor>
                                                                                </ext:FormLayout>
                                                                            </Body>
                                                    ...
                                                    <%--合同修改明细--%>
                                                    <ext:Anchor>
                                                        <ext:Panel ID="Panel3" runat="server" Header="true" Title="合同主协议" BodyStyle="padding: 5px;" FormGroup="true">
                                                            <Body>
                                                                        ...
                                                                        <ext:Panel ID="Panel8" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout5" runat="server" LabelAlign="Left" LabelWidth="150">
                                                                                    <ext:Anchor>
                                                                                        <ext:DateField ID="dfAgreementBegin" runat="server" Width="200" FieldLabel="<font color='red'><b>协议期限(协议生效日)</b></font>">
                                                                                        </ext:DateField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
                                                                        ...
                                                                        <ext:Panel ID="Panel9" runat="server" Border="false" Header="false">
                                                                            <Body>
                                                                                <ext:FormLayout ID="FormLayout7" runat="server" LabelAlign="Left" LabelWidth="150">
                                                                                    <ext:Anchor>
                                                                                        <ext:DateField ID="dfAgreementEnd" runat="server" Width="200" FieldLabel="<font color='red'><b>协议期限(协议到期日)</b></font>">
                                                                                        </ext:DateField>
                                                                                    </ext:Anchor>
                                                                                    <ext:Anchor>
