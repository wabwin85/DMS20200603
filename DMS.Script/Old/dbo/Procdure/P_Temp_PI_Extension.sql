DROP Procedure [dbo].[P_Temp_PI_Extension]
GO


CREATE Procedure [dbo].[P_Temp_PI_Extension]
@SAPCode NVARCHAR(50),
@ToSAPCode NVARCHAR(50),
@SubBU NVARCHAR(50),
@ToSubBU NVARCHAR(50),
@AddMonth INT
...
BEGIN  
	...
	select @SubDealerID=DMA_ID from DealerMaster a where @ToSAPCode is not null and a.DMA_SAP_Code=@ToSAPCode
	SELECT @CC_ID=CC_ID FROM INTERFACE.ClassificationContract A WHERE A.CC_Code=@SubBU
	SELECT @SubCC_ID=CC_ID FROM INTERFACE.ClassificationContract A WHERE A.CC_Code=@ToSubBU
	...
	begin
		if @ToSAPCode is null or @ToSubBU is null
		begin
			...
			begin
				...
				values(@DCL_ID,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31')),ISNULL(@SAPCode,'')+'-'+@SubBU,@DealerID,GETDATE(),'00000000-0000-0000-0000-000000000000',@CC_ID)
			end
			delete #MPDat
			...
			SELECT DAT_PMA_ID,b.DAT_ID_New,@DCL_ID,A.DAT_DMA_ID_Actual,DAT_ProductLine_BUM_ID,DAT_AuthorizationType,DAT_HospitalListDesc,DAT_ProductDescription,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31')),'Temp' 
			...
			SELECT DAT_PMA_ID,b.DAT_ID_New,DAT_DCL_ID,DAT_DMA_ID_Actual,DAT_ProductLine_BUM_ID,DAT_AuthorizationType,DAT_HospitalListDesc,DAT_ProductDescription,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31')),'Temp','Insert',GETDATE(),'c763e69b-616f-4246-8480-9df40126057c' 
			FROM DealerAuthorizationTableTemp A 
			inner join #MPDat b on a.DAT_ID=b.DAT_ID
			WHERE A.DAT_DCL_ID=@LastContractId
			...
			SELECT c.DAT_ID_New,A.HOS_ID,NEWID(),A.HOS_Depart,A.HOS_DepartType,A.HOS_DepartRemark,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31'))
		...
		begin
				select @DCL_ID=DCL_ID from DealerContract  a inner join interface.ClassificationContract  b on a.DCL_CC_ID=b.CC_ID
				where DCL_DMA_ID=@SubDealerID and b.CC_Code =@ToSubBU
			
			if @DCL_ID is null
			begin
				set @DCL_ID=NEWID();
				insert into DealerContract (DCL_ID,DCL_StartDate,DCL_StopDate,DCL_ContractNumber,DCL_DMA_ID,DCL_CreatedDate,DCL_CreatedBy,DCL_CC_ID)
				values(@DCL_ID,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31')),ISNULL(@ToSAPCode,'')+'-'+@ToSubBU,@SubDealerID,GETDATE(),'00000000-0000-0000-0000-000000000000',@SubCC_ID)
			end
			delete #MPDat
			...
			INSERT INTO DealerAuthorizationTable (DAT_PMA_ID,DAT_ID,DAT_DCL_ID,DAT_DMA_ID,DAT_ProductLine_BUM_ID,DAT_AuthorizationType,DAT_HospitalListDesc,DAT_ProductDescription,DAT_StartDate,DAT_EndDate,DAT_Type)
			SELECT DAT_PMA_ID,b.DAT_ID_New,@DCL_ID,@SubDealerID,DAT_ProductLine_BUM_ID,DAT_AuthorizationType,DAT_HospitalListDesc,DAT_ProductDescription,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31')),'Temp' 
			FROM DealerAuthorizationTableTemp A 
			inner join #MPDat b on a.DAT_ID=b.DAT_ID
			WHERE A.DAT_DCL_ID=@LastContractId
			 ...
			 INSERT INTO DealerAuthorizationTableLog
			  (DAT_PMA_ID,DAT_ID,DAT_DCL_ID,DAT_DMA_ID,DAT_ProductLine_BUM_ID,DAT_AuthorizationType,DAT_HospitalListDesc,DAT_ProductDescription,DAT_StartDate,DAT_EndDate,DAT_Type,DAT_OperationType,DAT_OperationDate,DAT_OperationUser)
			  SELECT DAT_PMA_ID,b.DAT_ID_New,@DCL_ID,@SubDealerID,DAT_ProductLine_BUM_ID,DAT_AuthorizationType,DAT_HospitalListDesc,DAT_ProductDescription,'2017-01-01',DATEADD(MONTH,@AddMonth,CONVERT(datetime,'2016-12-31')),'Temp','Insert',GETDATE(),'c763e69b-616f-4246-8480-9df40126057c' 
			  FROM DealerAuthorizationTableTemp A 
			  inner join #MPDat b on a.DAT_ID=b.DAT_ID
				WHERE A.DAT_DCL_ID=@LastContractId
