<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrderHospital.ascx.cs" Inherits="DMS.Website.Controls.OrderHospital" %>
...
<script type="text/javascript">
  ...
  var addItemsHospital = function(grid) {
      if (grid.hasSelection()) {
          ...
          {   
              ...
              Coolite.AjaxMethods.OrderDetailWindowLP.DoAddItems(param1,param2,
              {
              success: function() {
                ...
                <ext:Panel ID="Panel1" runat="server" AutoHeight="true"
                    ...
                    <Buttons>
                        ...
                        <ext:Button ID="btnOk" runat="server" Text="确认" Icon="Disk"
                            ...
                            <Listeners>
                                <Click Handler="addItemsHospital(#{GridPanel1});" />
                            </Listeners>
                        </ext:Button>
