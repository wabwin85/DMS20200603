<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentApplyInit.aspx.cs" Inherits="DMS.Website.Pages.Consignment.ConsignmentApplyInit" %>
            ...
            <Body>
                <ext:BorderLayout ID="BorderLayout1" runat="server">
                    <North MarginsSummary="5 5 5 5" Collapsible="true">
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="寄售申请批量导入"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="下载模板">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_ConsignmentImport.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" Title="导入信息"
                                        ...
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="DealerSAP" DataIndex="DealerSAP" Header="经销商编号"
                                                ...
                                                <ext:Column ColumnID="ApplyNo" DataIndex="ApplyNo" Header="寄售合同"
                                                    Sortable="false" Width="150">
                                                </ext:Column>
                                                <ext:Column ColumnID="ErrorMessage" DataIndex="ErrorMessage" Header="错误信息" Width="300"
                                                    Sortable="false">
                                                </ext:Column>
                                            </Columns>
                                        </ColumnModel>
