<%@Page Title="" Language="C#" MasterPageFile="~/MasterPageKendo/Site.Master" AutoEventWireup="true" CodeBehind="TerminationList.aspx.cs" Inherits="DMS.Website.PagesKendo.Promotion.TerminationList" %>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="hidden" id="IptUserId" class="FrameControl" />
    <div class="content-main">
        <div class="col-xs-12 content-row" style="padding: 10px 10px 0px 10px;">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <table style="width: 100%;" class="KendoTable">
                        <tr>
                             <td style="width: 10%;"><i class='fa fa-blank'></i>&nbsp;申请编号</td>
                            <td style="width: 24%;">
                                <div id="QryTermainationNo" class="FrameControl"></div>
                            </td>
                            <td style="width: 10%;"><i class='fa fa-blank'></i>&nbsp;促销编号</td>
                            <td style="width: 23%;">
                                <div id="QryPromotionNo" class="FrameControl"></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 23%;">
                                <div id="QryCP" class="FrameControl"></div>
                            </td>
                            <td style="width: 10%;"><i class='fa fa-blank'></i>&nbsp;终止类型</td>
                            <td style="width: 23%;">
                                <div id="QryZZ" class="FrameControl"></div>
                            </td>
            ...
            <div class="panel panel-primary" style="margin-top: 10px; margin-bottom: 10px;">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class='fa fa-navicon' style="padding-left: 15px;"></i>&nbsp;查询结果</h3>
                </div>
                <div class="panel-body" style="padding: 0px;">
                    <div id="RstTemainationList" style="border-width: 0px;"></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/TerminationList.js?v=1.88"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            TerminationList.InitPage();
        });
    </script>
</asp:Content>
