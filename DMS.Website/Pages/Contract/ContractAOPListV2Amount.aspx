<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractAOPListV2Amount.aspx.cs"
    Inherits="DMS.Website.Pages.Contract.ContractAOPListV2Amount" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .x-grid3-col-RefYear, .x-grid3-col-AmountY, .x-grid3-col-AOPD_Amount_Y
        {
...
<body>
    ...
    <script type="text/javascript">
       ...
       var afterSaveDealerAOPDetails = function() {
        ...
        var afterSyHospitalAOP = function() {
            ...
            <Body>
                <ext:BorderLayout ID="BorderLayout2" runat="server">
                    ...
                    <Center Collapsible="True" MarginsSummary="0 5 5 5">
                        <ext:Panel runat="server" ID="PanelHospitalProduct" Border="false" Frame="true" Title="第一步：维护经销商医院指标: <img src='/resources/images/icons/flag_ch.png' > </img> 代表本次新授权医院(不含税指标)"
                            Icon="HouseKey">
                            <Body>
                    ...
                    <South Collapsible="True" MarginsSummary="0 5 0 5">
                        <ext:Panel runat="server" ID="PanelDealerAop" Border="false" Frame="true" Title="第二步：维护经销商医院指标: <img src='/resources/images/icons/exclamation.png' > </img> 经销商指标小于医院指标或者大于医院指标的20%(不含税指标)"
                            ...
                            <Buttons>
                                <ext:Button ID="Button6" runat="server" Text="保存并关闭" Icon="Disk" CommandArgument=""
                                    CommandName="" IDMode="Legacy">
                                    <Listeners>
                                        <Click Fn="ClosePage" />
                                    </Listeners>
                                </ext:Button>
                                <ext:Button ID="SyHospital" runat="server" Text="同步医院实际指标到经销商指标" Icon="ArrowRefresh"
                                    IDMode="Legacy">
                                    <AjaxEvents>
                                        <Click OnEvent="SyHospital_Click" Success="afterSyHospitalAOP();">
                                        </Click>
                                    </AjaxEvents>
                                </ext:Button>
                                <ext:Button ID="Button1" runat="server" Text="初始化医院实际指标和经销商指标" IDMode="Legacy" Icon="BellGo">
                                    <Listeners>
                                        <Click Handler=" Ext.Msg.confirm('Message', '确认初始化医院实际指标和经销商指标？',
                                                                                        function(e) { if (e == 'yes') { Coolite.AjaxMethods.ResetAOP({success:function(result){ if(result=='') { Ext.Msg.alert('Success', '同步成功！',function() {#{GridPanelAOPStore}.reload(); #{GridDealerAop}.reload();});} else { Ext.Msg.alert('Error', result);} },failure:function(err){Ext.Msg.alert('Error', err);}}); } });" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:Panel>
        ...
        <ext:Window ID="AOPHospitalWindow" runat="server" Icon="Group" Title="经销商医院实际指标设置"
                                                        ...
                                                        <ext:Panel ID="Panel6" runat="server" Frame="false" Header="true">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout6" runat="server" LabelWidth="100">
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:Label runat="server" ID="Label3" FieldLabel="金额">
                                                                        </ext:Label>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtUnit_1" runat="server" MaskRe="/[0-9\.]/" SelectOnFocus="false"
                                                                            Enabled="false" HideLabel="true" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
            ...
            <Buttons>
                ...
                <ext:Button ID="CancelButton" runat="server" Text="关闭" Icon="Cancel">
                    <Listeners>
                        <Click Handler="#{AOPHospitalWindow}.hide(null);" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:Window>
        <ext:Window ID="WindowDealerAop" runat="server" Icon="Group" Title="经销商指标设置" Closable="false"
                        ...
                        <ext:Panel runat="server" ID="Panel12" BodyBorder="false">
                            <Body>
                                <ext:BorderLayout ID="BorderLayout5" runat="server">
                                    ...
                                    <South Collapsible="True" MarginsSummary="0 0 0 5">
                                        <ext:Panel ID="panel13" runat="server" Frame="true" AutoHeight="true" Title="经销商商业采购指标小于医院实际指标或大于医院实际指标20%原因：">
                                            <Body>
            ...
            <Buttons>
                ...
                <ext:Button ID="Button4" runat="server" Text="关闭" Icon="Cancel">
                    <Listeners>
                        <Click Handler="#{WindowDealerAop}.hide(null);" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:Window>
