var ConsignmentMasterSetUpnPicker = {};

ConsignmentMasterSetUpnPicker = function () {
    var that = {};

    var business = 'MasterDatas.ConsignmentMasterSetUpnPicker';
    var pickedList = [];
    ...
    that.Init = function () {
        ...
        $('#OrderTypeId').val(Common.GetUrlParam('OrderType'));
        $("#HeaderId").val(Common.GetUrlParam('HeaderId'));
    ...
    function GetFnParams() {
        var data = {};
        data.QryProductLine = $('#QryProductLine').val();
        return data;
    };
    var fields = {
