...
{
    public class CfnSetCFNService : ABaseQueryService, IDealerFilterFac
    {
        #region Ajax Method
        ...
        public CfnSetCFNVO Init(CfnSetCFNVO model)
        {
            try
            {
        ...
        public string Query(CfnSetCFNVO model)
        {
            try
            {
                ICfns bll = new Cfns();
                ...
                IList<Cfn> query = bll.SelectByFilterNoSet(param, start, model.PageSize, out outCont);
