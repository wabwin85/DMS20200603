var QueryInventoryPrice = {};

QueryInventoryPrice = function () {
    var that = {};

    var business = 'Inventory.QueryInventoryPrice';
    ...
    that.Export = function () {
        ...
        urlExport = Common.UpdateUrlParams(urlExport, 'DownloadCookie', 'QueryInventoryPriceExport');
        ...
        startDownload(urlExport, 'QueryInventoryPriceExport');
    ...
    var createResultList = function () {
        $("#RstResultList").kendoGrid({
            ...
            //dataBinding: function (s) {
            //    debugger
            //    $('#lblInvSum').FrameLabel({
