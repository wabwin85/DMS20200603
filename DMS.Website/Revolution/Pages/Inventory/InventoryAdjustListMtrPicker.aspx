<%@ Page Title="其他出入库" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="InventoryAdjustListMtrPicker.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Inventory.InventoryAdjustListMtrPicker" %>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="hidden" id="QryWarehouseType" class="FrameControl" />
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/InventoryAdjustListMtrPicker.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            InventoryAdjustListMtrPicker.Init();
        });
    </script>
</asp:Content>
