<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageKendo/Site.Master" AutoEventWireup="true" CodeBehind="T2Termination.aspx.cs" Inherits="DMS.Website.Pages.ContractKendo.TTwo.T2Termination" %>
                            ...
                            <div class="panel-body" id="PnlContractContent">
                                <table style="width: 100%;" class="KendoTable">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 10%; display:none"><i class='fa fa-blank'></i>&nbsp;协议终止日期</td>
                                        <td style="width: 15%; display:none">
                                            <div id="AgreementEndDate" class="FrameControl"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10%; display:none"><i class='fa fa-blank'></i>&nbsp;合同开始日期</td>
                                        <td style="width: 15%; display:none">
                                            <div id="ContractDate" class="FrameControl"></div>
                                        </td>
                                       <td style="width: 10%; display:none"><i class='fa fa-blank'></i>&nbsp;合同开始日期</td>
                                        <td style="width: 15%; display:none">
                                            <div id="PaymentDate" class="FrameControl"></div>
                                        </td>
                                    </tr>
                                    <tr style="">
                                        <td></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript" src="../script/T2Termination.js?v=129"></script>
