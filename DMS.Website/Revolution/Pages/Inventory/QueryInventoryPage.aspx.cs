...
namespace DMS.Website.Revolution.Pages.Inventory
{
    ...
    public partial class QueryInventoryPage : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string GetPDFInfo(string Lot, string Prop, string Upn)
        {
            string downname = "", filename = "", msg="";
            bool flag = true;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                strPath[0] = System.Web.HttpContext.Current.Server.MapPath("\\Upload\\UPN\\Licence\\" + ds.Tables[0].Rows[0]["AttachName"].ToString());
                ...
                if (File.Exists(CoaFile))
                {
                    ...
                    AddPdfs(Lot, Prop, out fileName);
                    AddTextWatermark(fileName, out NewWaterPdf);

                    strPath[1] = NewWaterPdf;
                    String fileName1 = Guid.NewGuid().ToString().Replace("-", "").ToUpper() + ".pdf";
                    String OutputPdfPath = System.Web.HttpContext.Current.Server.MapPath(PdfHelper.COA_FILE_PATH + fileName1);
                    PdfHelper.MergePdf(strPath, OutputPdfPath);
                    filename = ds.Tables[0].Rows[0]["AttachName"].ToString();
                    downname = fileName1;
                }
                else
                {
        ...
        public static void AddPdfs(string Lot, string Upn, out String fileName)
        {
            ...
            string targetPath = System.Web.HttpContext.Current.Server.MapPath(PdfHelper.COA_FILE_PATH + fileName);
            fileName = targetPath;
        ...
        public static void AddTextWatermark(string Filename, out string OutputPdfPath)
        {
            ...
            OutputPdfPath = System.Web.HttpContext.Current.Server.MapPath(PdfHelper.COA_FILE_PATH + newfileName);
