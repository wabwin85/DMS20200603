<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerHomePage.aspx.cs"
    Inherits="DMS.Website.Pages.Home.DealerHomePage" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var DownloadFile = function () {
            var url = '../Download.aspx?downloadname=波科三证.zip&filename=波科三证.zip';
...
<body>
    <form id="form1" runat="server">
                                    ...
                                    <North MarginsSummary="0 0 0 0">
                                        <ext:Panel ID="Panel4" runat="server" Title="<%$ Resources:Panel4.Title%>" Icon="Information"
                                            ...
                                            <Tools>
                                                ...
                                                <ext:Tool Type="Search" Qtip="<%$ Resources:Panel4.Tool.Search.Qtip%>" Handler="window.parent.loadExample('/Pages/DCM/BulletinSearch.aspx','subMenu179',MsgList.BulletinSearchTabName);" />
                                            </Tools>
                                            <Body>
                                                    ...
                                                    <ext:GridPanel ID="GridPanelBulletin" runat="server" StoreID="BulletinStore" Border="false"
                                                        ...
                                                        <ColumnModel ID="ColumnModel1" runat="server">
                                                            <Columns>
                                                                ...
                                                                <%--<ext:CheckColumn ColumnID="IsRead" DataIndex="IsRead" Header="是否已读">
                                                            </ext:CheckColumn>
                                                            <ext:CheckColumn ColumnID="IsConfirm" DataIndex="IsConfirm" Header="是否已确认">
                                                            </ext:CheckColumn>--%>
                                    ...
                                    <ext:TreePanel ID="TreePanel1" runat="server" Title="<%$ Resources:Panel3.TreePanel1.Title%>"
                                        ...
                                        <TopBar>
                                            <ext:Toolbar runat="server">
                                                <Items>
                                                    <ext:LinkButton runat="server" Text="波科证照下载">
                                                        <Listeners>
                                                            ...
                                                            <ext:Panel ID="Panel9" runat="server" Border="false">
                                                                <Body>
                                                                    <ext:FormLayout ID="FormLayout4" runat="server">
                                                                        ...
                                                                        <ext:Anchor>
                                                                            <ext:Checkbox ID="BulletinIsRead" runat="server" FieldLabel="<%$ Resources:BulletinDetailWindow.Panel9.BulletinIsRead.FieldLabel%>"
                                                                                Disabled="true">
                                                                            </ext:Checkbox>
                                                                        </ext:Anchor>
                                                                    </ext:FormLayout>
                                                            ...
                                                            <ext:Panel ID="Panel10" runat="server" Border="false">
                                                                <Body>
                                                                    <ext:FormLayout ID="FormLayout5" runat="server">
                                                                        ...
                                                                        <ext:Anchor>
                                                                            <ext:Checkbox ID="BulletinIsConfirm" runat="server" FieldLabel="<%$ Resources:BulletinDetailWindow.Panel10.BulletinIsConfirm.FieldLabel%>"
                                                                                Disabled="true">
                                                                            </ext:Checkbox>
                                                                        </ext:Anchor>
                                                                    </ext:FormLayout>
        ...
        <ext:Window ID="WindowRemind" runat="server" Icon="Comment" Title="<%$ Resources:WindowRemind.Message.Title%>"
            ShowOnLoad="false" AutoHeight="false" Width="250" Height="150" ButtonAlign="Center">
            <Body>
                <div>
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<br />
                </div>
                <div style="text-indent: 2em; font-size: larger; line-height: 20px;">
                    用户您好，请检查是否还有未披露的第三方公司或已披露但未上传所需文件。如有，请立即披露或补传文件。<br />
            ...
            <Buttons>
                <ext:Button ID="RemindConnel" runat="server" Text="关闭">
                    <Listeners>
                        <Click Handler="#{WindowRemind}.hide(null);" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:Window>
        <ext:Hidden ID="hidShiomentInitNo" runat="server">
        </ext:Hidden>
        <ext:Window ID="WindowRemindShipment" runat="server" Icon="Comment" Title="销售单处理完成通知"
            ShowOnLoad="false" AutoHeight="false" Width="300" Height="180" ButtonAlign="Center">
            <Body>
                <div>
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<br />
                </div>
                <div style="text-indent: 2em; font-size: larger; line-height: 20px;">
                    <span runat="server" id="spanShipment1"></span>
                </div>
            </Body>
            <Buttons>
                <ext:Button ID="Button1" runat="server" Text="确认">
                    <Listeners>
                        <Click Handler="Coolite.AjaxMethods.SubmentShipmenInit({success:function(){window.parent.loadExample('/Pages/Shipment/ShipmentInitList.aspx','subMenu445','销售数据批量上传');#{WindowRemindShipment}.hide(null);},failure:function(err){Ext.Msg.alert('Error', err);}});" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:Window>

        <ext:Store ID="InventoryStore" runat="server" UseIdConfirmation="false" AutoLoad="false"
            OnRefreshData="InventoryStore_Refresh">
            <Proxy>
                <ext:DataSourceProxy />
            </Proxy>
            <Reader>
        ...
        <ext:Window ID="WindowNearEffectInventory" runat="server" Icon="Group" Title="心脏节律管理-近效期折扣产品列表"
            Resizable="false" Header="false" Width="700" Height="380" AutoShow="false" Modal="true"
            ShowOnLoad="false">
            <Body>
                <ext:FitLayout ID="FitLayout5" runat="server">
                    <ext:GridPanel ID="GridPanelNearEffectInventory" runat="server" StoreID="InventoryStore"
                        Border="false" Icon="Lorry" AutoScroll="true" EnableHdMenu="false"
                        StripeRows="true">
                        <ColumnModel ID="ColumnModel5" runat="server">
                            <Columns>
                                <ext:Column ColumnID="Material" DataIndex="Material" Header="产品编号" Width="120">
                                </ext:Column>
                                <ext:Column ColumnID="Batch" DataIndex="Batch" Header="批号" Width="120">
                                </ext:Column>
                                <ext:Column ColumnID="Quantity" DataIndex="Quantity" Header="数量" Width="80">
                                </ext:Column>
                                <ext:Column ColumnID="ExpirationDate" DataIndex="ExpirationDate" Header="有效期" Width="120" Hidden="true">
                                    <Renderer Fn="Ext.util.Format.dateRenderer('Y-m-d')" />
                                </ext:Column>
                                <ext:Column ColumnID="LeftDays" DataIndex="LeftDays" Header="剩余可用天数" Width="100" Hidden="true">
                                </ext:Column>
                                <ext:Column ColumnID="DiscountRate" DataIndex="DiscountRate" Header="折扣率" Width="80">
                                </ext:Column>
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
                        ...
                        <BottomBar>
                            <ext:PagingToolbar ID="PagingToolbar1" runat="server" PageSize="30" StoreID="InventoryStore"
                                DisplayInfo="true" EmptyMsg="没有数据显示" />
                        </BottomBar>
                        <SaveMask ShowMask="true" />
                        <LoadMask ShowMask="true" Msg="处理中" />
            ...
            <Buttons>
                <ext:Button ID="Button2" runat="server" Text="关闭" Icon="Cancel">
                    <Listeners>
                        <Click Handler="#{WindowNearEffectInventory}.hide(null);" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:Window>
