...
{
    public partial class HostipalSales : BasePage
    {
        ...
        private void RefreshData(int start, int limit)
        {
            ...
            DataTable query = _businessReport.HospitalSales(GetQueryList(), (start == -1 ? 0 : start), (limit == -1 ? this.PagingToolBar1.PageSize : limit), out totalCount).Tables[0];
        ...
        {
            DataTable dt = _businessReport.ExportHospitalSales(GetQueryList()).Tables[0];
