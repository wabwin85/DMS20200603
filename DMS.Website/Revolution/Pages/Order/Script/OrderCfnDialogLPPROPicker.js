...
var OrderCfnDialogLPPROPicker = {};
//平台及一级经销商促销订单

OrderCfnDialogLPPROPicker = function () {
    var that = {};

    var business = 'Order.OrderCfnDialogLPPROPicker';
    var pickedList = [];
    var checkparamList = [];
    ...
    that.CreateResultList = function () {
        ...
        $("#RstResultList").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "CustomerFaceNbr", title: "产品型号", width: '120px',
                    headerAttributes: { "class": "text-center text-bold", "title": "产品型号" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "EnglishName", title: "产品英文名称", width: '80px',
                    headerAttributes: { "class": "text-center text-bold", "title": "产品英文名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "ChineseName", title: "产品中文名称", width: '80px',
                    headerAttributes: { "class": "text-center text-bold", "title": "产品中文名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "Price", title: "产品单价", width: '120px', template: function (gridrow) { if (gridrow.Price == null || "" == gridrow.Price || undefined == gridrow.Price) gridrow.Price = 0; return gridrow.Price },
                    headerAttributes: { "class": "text-center text-bold", "title": "产品单价" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "UOM", title: "包装单位", width: '120px',
