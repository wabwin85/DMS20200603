...
{
    public partial class UploadInvoice : BasePage
    {
        private ISendInvoice _bll = null;
        [Dependency]
        public ISendInvoice bll
        {
            get { return _bll; }
            set { _bll = value; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && !Ext.IsAjaxRequest)
            {
                ...
                bool writable = pers.IsPermissible(Business.SendInvoice.Action_UploadSendInvoice, PermissionType.Write);
        ...
        {
            DataSet ds = bll.GetSendInvoiceErrorList(new Guid(_context.User.Id));
        ...
        protected void UploadClick(object sender, AjaxEventArgs e)
        {
            if (this.FileUploadField1.HasFile)
            {
                ...
                string file = Server.MapPath("\\Upload\\SendInvoice\\" + newFileName);
        ...
        protected void ImportClick(object sender, AjaxEventArgs e)
        {
            ...
            string file = Server.MapPath("\\Upload\\SendInvoice\\" + this.hidFileName.Text);
            ...
            if (File.Exists(file))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (bll.ImportSendInvoice(ds, hidFileName.Text))
                    {
