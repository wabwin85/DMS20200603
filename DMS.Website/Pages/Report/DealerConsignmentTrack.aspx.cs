...
namespace DMS.Website.Pages.Report
{
    ...
    public partial class DealerConsignmentTrack : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_DealerConsignmentTrack;
        ...
        protected void initSearchCondition()
        {
            ...
            this.txtStartDate.Value = DateTime.Now.AddMonths(-6).AddDays(1);
        }
        ...
        protected void btnSearch_Click(object sender, AjaxEventArgs e)
        {
            ...
            ReportParameter[] parametrts = new ReportParameter[6];
            ...
            parametrts[3] = new ReportParameter("ProductLineId", ProductLine, false);
            parametrts[4] = new ReportParameter("Upn", this.txtCfnCode.Text, false);
            parametrts[5] = new ReportParameter("LotNumber", this.txtLotNumber.Text, false);
