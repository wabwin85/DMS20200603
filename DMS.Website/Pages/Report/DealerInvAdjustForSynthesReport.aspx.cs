...
namespace DMS.Website.Pages.Report
{
    ...
    public partial class DealerInvAdjustForSynthesReport : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_DealerInvAdjustForSynthesReport;
        ...
        protected void btnSearch_Click(object sender, AjaxEventArgs e)
        {
            ...
            parametrts[4] = new ReportParameter("CfnNumber", this.txtCfnCode.Text, false);
