...
ALTER Procedure [dbo].[GC_MailRemind]
AS
BEGIN
	-------------------------------------------------------
	--1. 第三方披露表邮件通知
	...
	BEGIN
		...
		+@strMassage+'<br/>，请登陆DMS系统进行相应审批<br/> 链接：https://bscdealer.cn <br/><br/>蓝威DMS系统<br>――――――――――――――――――――――――<br>此邮件为系统自动发送，请勿回复！<br>谢谢';
	...
	BEGIN
		...
		INSERT INTO MailMessageQueue (MMQ_ID,MMQ_QueueNo,MMQ_From,MMQ_To,MMQ_Subject,MMQ_Body,MMQ_Status,MMQ_CreateDate,MMQ_SendDate)
		SELECT NEWID(),'email','','aaron.ma@gmedtech.com',@strSubject,@strBody,'Winting',GETDATE(),NULL 
	END
