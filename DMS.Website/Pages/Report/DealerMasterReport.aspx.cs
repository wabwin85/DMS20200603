...
{
    public partial class DealerMasterReport : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_DealerMasterReport;
        ...
        protected void btnSearch_Click(object sender, AjaxEventArgs e)
        {
            ...
            parametrts[1] = new ReportParameter("UserId", RoleModelContext.Current.User.Id, false);
