    ...
    that.Init = function () {
        ...
        FrameUtil.SubmitAjax({
            ...
            callback: function (model) {
                ...
                $('#BtnExportsalesAOPRpt').FrameButton({
                    text: '导出',
                    icon: 'file-excel-o',
                    onClick: function () {
    ...
    var createResultList = function () {
        $("#RstResultList").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "ChineseName", title: "经销商名称", width: 120,
                    headerAttributes: { "class": "text-center text-bold", "title": "经销商名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "SAPCode", title: "ERPCode", width: 120,
                ...
                {
                    field: "Order_Type", title: "订单类型", width: 150,
                ...
                {
                    field: "SubmitDate", title: "订单日期", width: 150,
                    headerAttributes: { "class": "text-center text-bold", "title": "订单日期" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "RDD", title: "期望到货日期", width: 150,
                ...
                {
                    field: "ConfirmDate", title: "订单处理时间", width: 150,
                ...
                {
                    field: "ArticleNumber", title: "产品编号", width: 150,
