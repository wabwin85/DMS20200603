var DealerHospitalQuota = {};

DealerHospitalQuota = function () {
    var that = {};

    var business = 'Report.DealerHospitalQuota';
    ...
    that.Init = function () {
        ...
        FrameUtil.SubmitAjax({
            ...
            callback: function (model) {
                ...
                $('#BtnExportDealerHospitalQuota').FrameButton({
                    text: '导出',
                    icon: 'file-excel-o',
                    onClick: function () {
                        that.ExportDealerHospitalQuota();
                    }
                });                                
    ...
    var createResultList = function () {
        $("#RstResultList").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "CQName", title: "指标分类", width: 150,
                ...
                {
                    field: "HospitalNbr", title: "医院编号", width: 100,
    ...
    that.ExportDealerHospitalQuota = function () {
        var data = that.GetModel();

        var urlExport = Common.ExportUrl;
        urlExport = Common.UpdateUrlParams(urlExport, 'Business', business);
        urlExport = Common.UpdateUrlParams(urlExport, 'DownloadCookie', 'DealerHospitalQuotaExportByDealer');
        urlExport = Common.UpdateUrlParams(urlExport, 'ExportType', 'ExportDealerHospitalQuota');
        ...
        urlExport = Common.UpdateUrlParams(urlExport, 'QryHospitalName', data.QryHospitalName);
        urlExport = Common.UpdateUrlParams(urlExport, 'QryYear', data.QryYear);
        startDownload(urlExport, 'DealerHospitalQuotaExportByDealer');
    }
