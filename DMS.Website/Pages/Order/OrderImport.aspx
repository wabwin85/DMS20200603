<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderImport.aspx.cs" Inherits="DMS.Website.Pages.Order.OrderImport" %>
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_Order.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
