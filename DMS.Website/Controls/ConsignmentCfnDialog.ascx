<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentCfnDialog.ascx.cs" Inherits="DMS.Website.Controls.ConsignmentCfnDialog" %>
...
<script language="javascript" type="text/javascript">
    ...
    var addItems = function(grid) {
        if (grid.hasSelection()) {
            ...
            Coolite.AjaxMethods.ConsignmentCfnDialog.DoAddItems(param,
                        {
                            success: function() {
                                DetailStoreLoad();
                                //clearItems();
