...
BEGIN CATCH 
 ...
 SET NOCOUNT OFF
	...
	VALUES(NEWID(),'email','','cooper.xu@grapecity.com','经销商'+@ContractType+'合同同步错误GC_ContractStateComplete，合同编号：'+CONVERT(nvarchar(50),@ContractId),@RtnMsg,'Waiting',GETDATE(),null)
