<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="ConsignmentApplyHeaderList.aspx.cs"
    Inherits="DMS.Website.Revolution.Pages.Consignment.ConsignmentApplyHeaderList" %>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryDelayStatus" class="FrameControl"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/ConsignmentApplyHeaderList.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ConsignmentApplyHeaderList.Init();
        });
    </script>
</asp:Content>
