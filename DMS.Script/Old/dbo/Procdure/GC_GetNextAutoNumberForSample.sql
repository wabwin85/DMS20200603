DROP  PROCEDURE [dbo].[GC_GetNextAutoNumberForSample]
GO
...
CREATE PROCEDURE [dbo].[GC_GetNextAutoNumberForSample]
...
--BEGIN TRAN
	...
	SET @NextAutoNbr = @DeptCode + '-' + @ClientID + '-' +  Convert(nvarchar(4),getdate(),112) + '-' + @NextAutoNbr
