...
GO
Create PROCEDURE [Workflow].[Proc_ConsignmentTransfer_GetHtmlData]
...
--数据信息
--表头
SELECT TH_No AS [No],d.ProductLineName,C.DMA_ChineseShortName AS FromDealer,b.DMA_ChineseShortName AS ToDealerName ,TH_Remark AS Remark,E.Name AS SalesName
...
LEFT JOIN interface.MDM_EmployeeMaster E ON E.EID=A.TH_SalesAccount
