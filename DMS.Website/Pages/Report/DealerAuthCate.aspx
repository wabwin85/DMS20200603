<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerAuthCate.aspx.cs" Inherits="DMS.Website.Pages.Report.DealerAuthCate" %>
...
<script type="text/javascript">
     ...
     function CheckCondition()
     {
        ...
        var ProductLine = <%=cbProductLine.ClientID%>.getValue();
        if (ProductLine == "")
        {
