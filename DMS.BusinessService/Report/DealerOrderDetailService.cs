...
{
    public class DealerOrderDetailService : ABaseQueryService,IQueryExport
    {
        #region Ajax Method
        ReportDao rptDao = new ReportDao();
        IRoleModelContext context = RoleModelContext.Current;
        public DealerOrderDetailVO Init(DealerOrderDetailVO model)
        {
            try
            {
        ...
        public DealerOrderDetailVO ChangeBrand(DealerOrderDetailVO model)
        {
            try
            {
        ...
        public string Query(DealerOrderDetailVO model)
        {
            try
            {
