...
POReceiptDeliveryImport = function () {
    var that = {};
    var business = 'POReceipt.POReceiptDeliveryImport';
    var IMPORT_TYPE = 'POReceiptDeliveryImport';
    var IMPORT_NAME = 'sheet1';
    var IsVRImport = Common.GetUrlParam('IsVRImport');
    that.Init = function () {
    ...
    function onUpload(e) {
        var files = e.files;
        e.data = { AutoNbr: $('#AutoNbr').val(), IsVR: IsVRImport };
