<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndoScoreCardImport.aspx.cs" Inherits="DMS.Website.Pages.ScoreCard.EndoScoreCardImport" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var editId = '';
        var editControls = [
                          { name: 'DealerName', field: {xtype:"textfield",width:180,maxLength:200,allowBlank:false} },
                          { name: 'No', field: {xtype:"textfield",width:100,maxLength:20,allowBlank:false} },
                          { name: 'Quarter', field: {xtype:"numberfield",width:40,allowBlank:false,minValue:0.0,maxValue:4.0,allowNegative:false,allowDecimals:false,inputType:"text"} },
                          { name: 'Score1', field: {xtype:"textfield",width:140,maxLength:10,allowBlank:false} },
                          { name: 'Score2', field: {xtype:"textfield",width:140,maxLength:10,allowBlank:false} },
                          { name: 'Remark', field: {xtype:"textfield",width:150,maxLength:300,allowBlank:false} }
                        ];
        ...
        var rowCommand = function(command, record, row){
            if (command == "Edit"){
                ...
                var tbDealerName = Ext.getCmp('tbDealerName');
                var tbNo = Ext.getCmp('tbNo');
                var tbScore1 = Ext.getCmp('tbScore1');
                var tbScore2 = Ext.getCmp('tbScore2');
                var tbQuarter = Ext.getCmp('tbQuarter');
            ...
            <Reader>
                <ext:JsonReader ReaderID="Id">
                    <Fields>
                        ...
                        <ext:RecordField Name="Score1" />
                        <ext:RecordField Name="Score2" />
                        <ext:RecordField Name="Remark"/>
                        <ext:RecordField Name="DealerNameErrMsg" />
                        <ext:RecordField Name="NoErrMsg" />
                        <ext:RecordField Name="QuarterErrMsg" />
                        <ext:RecordField Name="Score1ErrMsg" />
                        <ext:RecordField Name="Score2ErrMsg" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_ScoreCard.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: GridPanel3.Title %>" StoreID="ResultStore" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="DealerName" DataIndex="DealerName" Header="<%$ Resources: GridPanel3.ColumnModel3.DealerName.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="No" DataIndex="No" Header="<%$ Resources: GridPanel3.ColumnModel3.No.Header  %>" Sortable="false" Width="130px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="Year" DataIndex="Year" Header="<%$ Resources: GridPanel3.ColumnModel3.Year.Header %>" Sortable="false" Width="70px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="Quarter" DataIndex="Quarter" Header="<%$ Resources: GridPanel3.ColumnModel3.Quarter.Header %>" Sortable="false" Width="50px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="Score1" DataIndex="Score1" Header="<%$ Resources: GridPanel3.ColumnModel3.Score1.Header %>" Sortable="false" Width="150px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="Score2" DataIndex="Score2" Header="<%$ Resources: GridPanel3.ColumnModel3.Score2.Header %>" Sortable="false" Width="150px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="Remark" DataIndex="Remark" Header="<%$ Resources: GridPanel3.ColumnModel3.Remark.Header %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
