...
namespace DMS.Website.Pages.Report
{
    ...
    public partial class DealerSalesForLPReport : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_DealerSalesForLPReport;
        ...
        protected void btnSearch_Click(object sender, AjaxEventArgs e)
        {
            ...
            parametrts[5] = new ReportParameter("DealerId", DealerId, false);
