...
namespace DMS.Website.Pages.Report
{
    ...
    public partial class DealerAOPReport : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_DealerAOP;
        ...
        protected void btnSearch_Click(object sender, AjaxEventArgs e)
        {
            ...
            {
                COPPeriod = this.cbCOP.SelectedItem.Text;
            }
            ...
            parametrts[1] = new ReportParameter("Year", COPPeriod, false);
