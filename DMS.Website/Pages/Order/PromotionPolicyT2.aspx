<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PromotionPolicyT2.aspx.cs"
    Inherits="DMS.Website.Pages.Order.PromotionPolicyT2" %>
            ...
            <Reader>
                <ext:JsonReader ReaderID="Id">
                    <Fields>
                        ...
                        <ext:RecordField Name="NotUsedQty" />
                        <ext:RecordField Name="LastAvaliableQty" />
                        <ext:RecordField Name="Tiers" />
                        <ext:RecordField Name="LimitQty" />
                        <ext:RecordField Name="TotalLimitQty" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" Title="查询结果" StoreID="ResultStore"
                                        ...
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="DMAName" DataIndex="DMAName" Header="经销商" Width="210">
                                                ...
                                                <ext:Column ColumnID="FreeQty" DataIndex="FreeQty" Header="赠品数量" Align="Right">
                                                </ext:Column>
                                                <ext:Column ColumnID="AdjustQty" DataIndex="AdjustQty" Header="调整数量" Align="Right">
                                                    <Editor>
                                                ...
                                                <ext:Column ColumnID="AdjustRemark" DataIndex="AdjustRemark" Header="调整备注" Width="200">
                                                    <Editor>
                                                ...
                                                <ext:Column ColumnID="ShipmentQty" DataIndex="ShipmentQty" Header="总数量（用量或采购）">
                                                </ext:Column>
                                                <ext:Column ColumnID="NotUsedQty" DataIndex="NotUsedQty" Header="剩余未计算数量">
                                                </ext:Column>
                                                <ext:Column ColumnID="LastAvaliableQty" DataIndex="LastAvaliableQty" Header="上次获取赠品数">
                                                </ext:Column>
                                                <ext:Column ColumnID="Tiers" DataIndex="Tiers" Header="阶梯级数">
                                                </ext:Column>
                                                <ext:Column ColumnID="LimitQty" DataIndex="LimitQty" Header="赠品上限值（PI）">
                                                </ext:Column>
                                                <ext:Column ColumnID="TotalLimitQty" DataIndex="TotalLimitQty" Header="政策历史累计获取赠品数（PI）">
                                                </ext:Column>
