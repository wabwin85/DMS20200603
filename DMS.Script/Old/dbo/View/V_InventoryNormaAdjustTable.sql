DROP view [dbo].[V_InventoryNormaAdjustTable]
GO

CREATE view [dbo].[V_InventoryNormaAdjustTable]
as
    select InventoryAdjustHeader.IAH_ID as Id,
           ...
           Convert(decimal(18,2),dbo.InventoryAdjustLot.IAL_UnitPrice) AS '产品单价'
           ...
           group by InventoryAdjustHeader.IAH_ID,dbo.CFN.CFN_CustomerFaceNbr,dbo.CFN.CFN_ChineseName,dbo.CFN.CFN_EnglishName,V_LotMaster.LTM_LotNumber,
                    dbo.Product.PMA_UnitOfMeasure,dbo.InventoryAdjustLot.IAL_UnitPrice
GO
