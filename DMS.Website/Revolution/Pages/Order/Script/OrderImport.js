...
OrderImport = function () {
    ...
    var business = 'Order.OrderImport';
    var IMPORT_TYPE = 'OrderImport';
    ...
    var createResultList = function () {
        $("#ImportErrorGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "ProductLine", title: "产品线", width: '100px', editable: true,
            ...
            dataBound: function (e) {
                $("#IsFirstLoad").val(false);//默认为true，首次加载不绑定缓存表中数据
                var grid = e.sender;
