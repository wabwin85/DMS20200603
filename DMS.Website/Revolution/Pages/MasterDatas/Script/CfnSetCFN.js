...
CfnSetCFN = function () {
    ...
    var business = 'MasterDatas.CfnSetCFN';
    var pickedList = [];
    ...
    var createResultList = function () {
        $("#RstResultList").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "ChineseName", title: "中文说明", width: '150px',
                    headerAttributes: { "class": "text-center text-bold", "title": "中文说明" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "PCTName", title: "产品分类", width: '100px',
                    headerAttributes: { "class": "text-center text-bold", "title": "产品分类" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "PCTEnglishName", title: "产品分类英文名称", width: '120px',
                ...
                {
                    field: "Implant", title: "植入", width: '60px',
