...
{
    public class ReturnResultImportService : ABaseQueryService
    {
        #region Ajax Method
        ...
        public ReturnResultImportVO Init(ReturnResultImportVO model)
        {
            try
            {
        ...
        public string Query(ReturnResultImportVO model)
        {
            try
            {
