...
function FileProgress(file, targetid)
{
    ...
    if (!this.fileProgressElement)
    {
        ...
        this.messageSpan.className = swfu.settings.custom_settings.percent_css;
        //this.percentSpan.style.marginTop = "10px";
        this.messageSpan.innerHTML = "";
        this.fileProgressElement.appendChild(this.messageSpan);
...
FileProgress.prototype.reset = function()
{
    ...
    this.messageSpan = this.fileProgressElement.childNodes[5];
...
控制上传进度对象是否显示
*/
FileProgress.prototype.setMessage = function (message) {
