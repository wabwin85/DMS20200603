<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipmentToDealerList.aspx.cs" Inherits="DMS.Website.Pages.Shipment.ShipmentToDealerList" %>
...
<body>
    ...
    <ext:store ID="OrderStatusStore" runat="server" UseIdConfirmation="true" OnRefreshData="Store_OrderStatus"
        AutoLoad="true">
        <Proxy>
            <ext:DataSourceProxy />
        </Proxy>
                                    ...
                                    <ext:Panel ID="Panel3" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbProductLine" runat="server" EmptyText="<%$ Resources:Panel1.FormLayout1.cbProductLine.EmptyText %>" Width="150"
                                    ...
                                    <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbDealer" runat="server" EmptyText="<%$ Resources:Panel1.FormLayout2.cbDealer.EmptyText %>" Width="220" Editable="true"
                                                        TypeAhead="true" StoreID="DealerStore" ValueField="Id" DisplayField="ChineseName" Mode="Local"
                                                        ListWidth="300" Resizable="true" FieldLabel="<%$ Resources:Panel1.FormLayout2.cbDealer.FieldLabel %>">
                                                        <Triggers>
                                    ...
                                    <ext:Panel ID="Panel5" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbOrderStatus" runat="server" EmptyText="<%$ Resources:Panel1.FormLayout3.cbOrderStatus.EmptyText %>" Width="150" Editable="false"
                                                        TypeAhead="true" StoreID="OrderStatusStore" ValueField="Key" DisplayField="Value"
                                                        FieldLabel="<%$ Resources:Panel1.FormLayout3.cbOrderStatus.FieldLabel %>">
                                                        <Triggers>
                            ...
                            <ext:Button ID="btnInsert" runat="server" Text="<%$ Resources:Panel1.btnInsert.Text %>" Icon="Add" IDMode="Legacy">
                                <AjaxEvents>
                                    <Click Before="#{GridPanel1}.getSelectionModel().clearSelections();" OnEvent="ShowDetails"
                                        Failure="Ext.MessageBox.alert(MsgList.btnInsert.FailureTitle, MsgList.btnInsert.FailureMsg);" Success="#{cbDealerWin}.clearValue();#{cbDealerWin}.setValue(#{hiddenDealerId}.getValue());#{cbProductLineWin}.clearValue();#{cbHospitalWin}.clearValue();#{ProductLineWinStore}.reload();#{HospitalWinStore}.reload();ClearItems();#{GridPanel2}.clear();#{hiddenIsModified}.setValue('new');">
                                        <ExtraParams>
                            ...
                            <ext:FitLayout ID="FitLayout1" runat="server">
                                <ext:GridPanel ID="GridPanel1" runat="server" Title="<%$ Resources:GridPanel1.Title %>" StoreID="ResultStore"
                                    ...
                                    <ColumnModel ID="ColumnModel1" runat="server">
                                        <Columns>
                                            <ext:Column ColumnID="DealerId" DataIndex="DealerId" Header="<%$ Resources:GridPanel1.ColumnModel1.DealerId.Header %>" Width="150">
                                                <Renderer Handler="return getNameFromStoreById(DealerStore,{Key:'Id',Value:'ChineseName'},value);" />
                                            </ext:Column>
                                            <ext:Column ColumnID="OrderNumber" DataIndex="OrderNumber" Header="<%$ Resources:GridPanel1.ColumnModel1.OrderNumber.Header %>" Width="150">
                                            </ext:Column>
                                            ...
                                            <ext:Column ColumnID="TotalAmount" DataIndex="TotalAmount" Header="<%$ Resources:GridPanel1.ColumnModel1.TotalAmount.Header %>" Width="80"
                                    ...
                                    <AjaxEvents>
                                        <Command OnEvent="ShowDetails" Failure="Ext.MessageBox.alert(MsgList.ShowDetails.FailureTitle, MsgList.ShowDetails.FailureMsg);"
                                            Success="#{cbDealerWin}.clearValue(); #{cbDealerWin}.setValue(#{hiddenDealerId}.getValue());#{cbProductLineWin}.clearValue(); #{ProductLineWinStore}.reload();#{cbHospitalWin}.clearValue();#{HospitalWinStore}.reload();ClearItems();#{GridPanel2}.reload();#{hiddenIsModified}.setValue('old');">
                                            <EventMask ShowMask="true" Target="CustomTarget" CustomTarget="={#{GridPanel1}.body}" />
                                            <ExtraParams>
    ...
    <ext:window ID="DetailWindow" runat="server" Icon="Group" 
        Title="<%$ Resources: DetailWindow.Title %>" Width="900"
                                            ...
                                            <ext:Panel ID="Panel7" runat="server" Border="false" Header="false">
                                                <Body>
                                                    <ext:FormLayout ID="FormLayout4" runat="server" LabelAlign="Left" LabelWidth="60">
                                                        <ext:Anchor>
                                                            <ext:ComboBox ID="cbDealerWin" runat="server" Width="250" Editable="true" TypeAhead="true" Mode="Local"
                                                                StoreID="DealerStore" ValueField="Id" DisplayField="ChineseName" FieldLabel="<%$ Resources: Panel7.FormLayout4.cbDealerWin.FieldLabel %>"
                                                                ListWidth="300" Resizable="true" AllowBlank="false" BlankText="<%$ Resources: Panel7.FormLayout4.cbDealerWin.BlankText %>" EmptyText="<%$ Resources: Panel7.FormLayout4.cbDealerWin.EmptyText %>">
                                                            </ext:ComboBox>
                                                        </ext:Anchor>
                                                        <ext:Anchor>
                                                            <ext:ComboBox ID="cbProductLineWin" runat="server" Width="200" Editable="false" TypeAhead="true"
                                                                ...
                                                                ListWidth="300" Resizable="true" AllowBlank="false" BlankText="<%$ Resources: Panel7.FormLayout4.cbProductLineWin.BlankText %>" EmptyText="<%$ Resources: Panel7.FormLayout4.cbProductLineWin.EmptyText %>">
                                                                <Triggers>
                                            ...
                                            <ext:Panel ID="Panel8" runat="server" Border="false" Header="false">
                                                <Body>
                                                    <ext:FormLayout ID="FormLayout5" runat="server" LabelAlign="Left" LabelWidth="60">
                                                        <ext:Anchor>
                                                            <ext:TextField ID="txtOrderNumberWin" runat="server" FieldLabel="<%$ Resources: Panel8.FormLayout5.txtOrderNumberWin.FieldLabel %>" ReadOnly="true" Width="200" />
                                                        </ext:Anchor>
                                                        <ext:Anchor>
                                                            <ext:ComboBox ID="cbHospitalWin" runat="server" Width="200" Editable="true" TypeAhead="true"
                                                                ...
                                                                AllowBlank="false" BlankText="<%$ Resources:Panel8.FormLayout5.cbHospitalWin.BlankText %>" EmptyText="<%$ Resources:Panel8.FormLayout5.cbHospitalWin.EmptyText %>" Mode="Local" Resizable="true"
                                                                ListWidth="300" ItemSelector="div.list-item">
                                            ...
                                            <ext:Panel ID="Panel9" runat="server" Border="false" Header="false">
                                                <Body>
                                                    <ext:FormLayout ID="FormLayout6" runat="server" LabelAlign="Left" LabelWidth="60">
                                                        ...
                                                        <ext:Anchor>
                                                            <ext:TextField ID="txtOrderStatusWin" runat="server" FieldLabel="<%$ Resources:Panel9.FormLayout6.txtOrderStatusWin.FieldLabel %>" ReadOnly="true"
                                                                Width="80" />
                                                        </ext:Anchor>
                                                    </ext:FormLayout>
                                                </Body>
                                    ...
                                    <ext:ColumnLayout ID="ColumnLayout3" runat="server">
                                            ...
                                            <ext:Panel ID="Panel14" runat="server" Border="false" Header="false">
                                                <Body>
                                                    <ext:FormLayout ID="FormLayout8" runat="server" LabelAlign="Left" LabelWidth="60">
                                                        <ext:Anchor>
                                                            <ext:TextArea ID="txtMemoWin" runat="server" FieldLabel="<%$ Resources:Panel14.FormLayout8.txtMemoWin.FieldLabel %>" Width="250"/>
                                                        </ext:Anchor>
                                                    </ext:FormLayout>
                                                </Body>
                                            </ext:Panel>
                                        ...
                                        <ext:LayoutColumn ColumnWidth="0.38">
                                            <ext:Panel ID="Panel12" runat="server" Border="false" Header="false">
                                                <Body>
                                                    <ext:FormLayout ID="formLayout7" runat="server" LabelAlign="Left" LabelWidth="60">
                                                        <ext:Anchor>
                                                            <ext:TextField ID="txtInvoice" runat="server" FieldLabel="<%$ Resources:Panel12.formLayout7.txtInvoice.FieldLabel %>" Width="200"/>
                                                        </ext:Anchor>
                                                    </ext:FormLayout>
                                                </Body>
                                            </ext:Panel>
                                            ...
                                            <ext:Panel ID="PanelOrderType" runat="server" Border="false" Header="false">
                                                <Body>
                                                    <ext:FormLayout ID="formLayoutOrderType" runat="server" LabelAlign="Left" LabelWidth="60">
                                                        <ext:Anchor>
                                                            <ext:TextField ID="txtTotalAmount" runat="server" FieldLabel="<%$ Resources:PanelOrderType.txtTotalAmount.FieldLabel %>" ReadOnly="true"
                                                        ...
                                                        <ext:Anchor Horizontal="50%">
                                                            <ext:RadioGroup ID="orderTypeWin" runat="server" FieldLabel="<%$ Resources:PanelOrderType.orderTypeWin.FieldLabel %>" ColumnsNumber="2"
                    ...
                    <ext:Panel ID="Panel10" runat="server" Height="300" Header="false">
                        <Body>
                            <ext:FitLayout ID="FitLayout2" runat="server">
                                <ext:GridPanel ID="GridPanel2" runat="server" Title="<%$ Resources:GridPanel2.Title %>" StoreID="DetailStore"
                                    Border="false" Icon="Lorry" AutoWidth="true" ClicksToEdit="1" EnableHdMenu="false" StripeRows="true">
                                    <TopBar>
                                        <ext:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                <ext:ToolbarFill ID="ToolbarFill1" runat="server" />
                                                <ext:Button ID="AddItemsButton" runat="server" Text="<%$ Resources:GridPanel2.AddItemsButton.Text %>" Icon="Add">
                                                    <AjaxEvents>
                                    ...
                                    <ColumnModel ID="ColumnModel2" runat="server">
                                        <Columns>
                                            <ext:Column ColumnID="WarehouseName" DataIndex="WarehouseName" Header="<%$ Resources:GridPanel2.ColumnModel2.WarehouseName.Header %>" Width="180">
                                            </ext:Column>
                                            <ext:Column ColumnID="CFN" DataIndex="CFN" Header="<%$ Resources: resource,Lable_Article_Number  %>"
                                                Width="100">
                                            </ext:Column>
                                            <ext:Column ColumnID="UPN" DataIndex="UPN" Header="<%$ Resources:GridPanel2.ColumnModel2.UPN.Header %>" Width="100" Hidden="<%$ AppSettings: HiddenUPN  %>">
                                            </ext:Column>
                                            <ext:Column ColumnID="LotNumber" DataIndex="LotNumber" Header="<%$ Resources:GridPanel2.ColumnModel2.LotNumber.Header %>" Width="100">
                                            </ext:Column>
                                            <ext:Column ColumnID="ExpiredDate" DataIndex="ExpiredDate" Header="<%$ Resources:GridPanel2.ColumnModel2.ExpiredDate.Header %>" Width="80">
                                            </ext:Column>
                                            <ext:Column ColumnID="UnitOfMeasure" DataIndex="UnitOfMeasure" Header="<%$ Resources:GridPanel2.ColumnModel2.UnitOfMeasure.Header %>" Width="50"
                                                Hidden="<%$ AppSettings: HiddenUOM  %>">
                                            </ext:Column>
                                            <ext:Column ColumnID="TotalQty" DataIndex="TotalQty" Header="<%$ Resources:GridPanel2.ColumnModel2.TotalQty.Header %>" Width="50" Align="Right">
                                            </ext:Column>
                                            <ext:Column ColumnID="UnitPrice" DataIndex="UnitPrice" Header="<%$ Resources:GridPanel2.ColumnModel2.UnitPrice.Header %>" Width="60" Align="Right" Hidden="true">
                                                <Editor>
                                            ...
                                            <ext:Column ColumnID="ShipmentQty" DataIndex="ShipmentQty" Header="<%$ Resources:GridPanel2.ColumnModel2.ShipmentQty.Header %>" Width="60"
                                                Align="Right">
                                                <Editor>
                                                    <ext:NumberField ID="txtShipmentQty" runat="server" AllowBlank="false" AllowDecimals="false"
                                                        SelectOnFocus="true" AllowNegative="false">
                                                    </ext:NumberField>
                                                </Editor>
                                            </ext:Column>
                                            <ext:CommandColumn Width="50" Header="<%$ Resources:GridPanel2.ColumnModel2.CommandColumn.Header %>" Align="Center">
                                                <Commands>
                                            ...
                                            <ext:CommandColumn Width="60" Header="<%$ Resources:GridPanel2.ColumnModel2.CommandColumn.Header1 %>" Align="Center" Hidden="true">
                                                <Commands>
        ...
        <Buttons>
            ...
            <ext:Button ID="SubmitButton" runat="server" Text="<%$ Resources:DetailWindow.SubmitButton.Text %>" Icon="LorryAdd">
                <Listeners>
