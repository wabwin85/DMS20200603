var InventoryReturnImport = {};

InventoryReturnImport = function () {
    var that = {};

    var business = 'Inventory.InventoryReturnImport';
    var IMPORT_TYPE = 'InventoryReturnImport';
    ...
    var createResultList = function () {
        $("#ImportErrorGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "Warehouse", title: "仓库名称", width: 'auto', editable: true,
                ...
                {
                    field: "ReturnQty", title: "退货数量", width: '100px', editable: true,
                    headerAttributes: { "class": "text-center text-bold", "title": "退货数量" },
                ...
                {
                    field: "PurchaseOrderNbr", title: "退货价格", width: '100px', editable: true,
                    headerAttributes: { "class": "text-center text-bold", "title": "退货价格" },
                    attributes: { "class": "table-td-cell #if(data.PurchaseOrderNbrErrMsg !=null){#ipt-grid-cell-error#} #", "title": "#if(data.PurchaseOrderNbrErrMsg !=null) {# #=data.PurchaseOrderNbrErrMsg # #}#" }
                },
               {
