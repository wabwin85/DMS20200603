<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehouseSA.aspx.cs" 
    Inherits="DMS.Website.Pages.Inventory.WarehouseSA" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="Coolite.Ext.Web" Namespace="Coolite.Ext.Web" TagPrefix="ext" %>
<%@ Register Src="../../Controls/WarehouseSAEditor.ascx" TagName="WarehouseSAEditor"
    TagPrefix="uc1" %>
...
<body>
    ...
    <div>
        ...
        <uc1:WarehouseSAEditor ID="WarehouseSAEditor1" runat="server" />
    </div>
    </form>
</body>
</html>
