...
{
    public class OrderT2CfnSetDialogPickerService : ABaseQueryService
    {
        ...
        /// <returns></returns>
        public string SerarchQuery(OrderT2CfnSetDialogPickerVO model)
        {
            try
            {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public OrderT2CfnSetDialogPickerVO Query(OrderT2CfnSetDialogPickerVO model)
        {
            try
            {
                string id = model.CfnSetId;
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public OrderT2CfnSetDialogPickerVO DoAddCfnSet(OrderT2CfnSetDialogPickerVO model)
        {
            try
            {
