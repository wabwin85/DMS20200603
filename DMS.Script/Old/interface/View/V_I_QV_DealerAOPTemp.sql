Drop VIEW [interface].[V_I_QV_DealerAOPTemp]
GO

--Drop VIEW [interface].[V_I_QV_DealerAOPTemp];

Create VIEW   [interface].[V_I_QV_DealerAOPTemp]
AS
		SELECT TAB1.*
		,TAB2.AOPD_Year AS [Year]
		,TAB2.AOPD_Amount_1 AS Amount1
		,TAB2.AOPD_Amount_2 AS Amount2
		,TAB2.AOPD_Amount_3 AS Amount3
		,TAB2.AOPD_Amount_4 AS Amount4
		,TAB2.AOPD_Amount_5 AS Amount5
		,TAB2.AOPD_Amount_6 AS Amount6
		,TAB2.AOPD_Amount_7 AS Amount7
		,TAB2.AOPD_Amount_8 AS Amount8
		,TAB2.AOPD_Amount_9 AS Amount9
		,TAB2.AOPD_Amount_10 AS Amount10
		,TAB2.AOPD_Amount_11 AS Amount11
		,TAB2.AOPD_Amount_12 AS Amount12
		,TAB2.AOPD_Amount_Y AS AmountY
		FROM (
		...
		INNER JOIN V_AOPDealer_Temp  TAB2 ON TAB1.ContractId=TAB2.AOPD_Contract_ID
GO
