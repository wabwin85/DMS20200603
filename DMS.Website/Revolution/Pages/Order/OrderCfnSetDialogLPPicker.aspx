<%@ Page Title="平台及一级经销商订单申请添加组套产品" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="OrderCfnSetDialogLPPicker.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Order.OrderCfnSetDialogLPPicker" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/OrderCfnSetDialogLPPicker.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            OrderCfnSetDialogLPPicker.Init();
        });
    </script>
</asp:Content>
