<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderSalesSummaryInDayForT1LP.aspx.cs" Inherits="DMS.Website.Pages.Report.OrderSalesSummaryInDayForT1LP" %>
        ...
        <Body>
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                <North MarginsSummary="5 5 5 5" Collapsible="false" >
                    <ext:Panel ID="Panel1" runat="server" Title="二级经销商日订单销售汇总报表" AutoHeight="true" BodyStyle="padding: 5px;"
                                            ...
                                            <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbDealer" runat="server" EmptyText="经销商" Width="220"
                                                        Editable="false" TypeAhead="true" StoreID="DealerStore" ValueField="Id"
                                    ...
                                    <ext:Panel ID="Panel3" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:DateField ID="txtStartDate" runat="server" Width="150" FieldLabel="查询时间" />
                                                </ext:Anchor>
                                            </ext:FormLayout>
                                        </Body>
                                    </ext:Panel>
                        ...
                        <Body>
                            ...
                            <script language="javascript" type="text/javascript">
                                ...
                                function ResizeReport() {
                                    ...
                                    viewer.style.height = (htmlheight - 188) + "px";
                                }
