<%@ Page Title="销售人员负责医院报表" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="SalesHospitalReport.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Report.SalesHospitalReport" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/SalesHospitalReport.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            SalesHospitalReport.Init();
        });
    </script>
</asp:Content>
