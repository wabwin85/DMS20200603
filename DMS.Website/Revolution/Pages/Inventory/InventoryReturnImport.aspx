<%@ Page Title="Excel导入" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="InventoryReturnImport.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Inventory.InventoryReturnImport" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/InventoryReturnImport.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            InventoryReturnImport.Init();
        });
    </script>
</asp:Content>
