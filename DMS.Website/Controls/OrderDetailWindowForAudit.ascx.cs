...
namespace DMS.Website.Controls
{
    ...
    public partial class OrderDetailWindowForAudit : BaseUserControl
    {
        #region 公用
        ...
        {
            if (!IsDealer && (PageStatus == PurchaseOrderStatus.Submitted || PageStatus == PurchaseOrderStatus.Approved))
            {
                this.panelRejectReason.Hidden = false;
