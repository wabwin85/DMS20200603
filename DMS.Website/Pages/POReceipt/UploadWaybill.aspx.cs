...
{
    public partial class UploadWaybill : BasePage
    {
        private IPOReceipt _bll = null;
        [Dependency]
        public IPOReceipt bll
        {
            get { return _bll; }
            set { _bll = value; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && !Ext.IsAjaxRequest)
            {
                ...
                bool writable = pers.IsPermissible(Business.POReceipt.Action_UploadWaybill, PermissionType.Write);
        ...
        {
            DataSet ds = bll.GetErrorList(new Guid(_context.User.Id));
        ...
        protected void UploadClick(object sender, AjaxEventArgs e)
        {
            if (this.FileUploadField1.HasFile)
            {
                ...
                string file = Server.MapPath("\\Upload\\Waybill\\" + newFileName);
        ...
        protected void ImportClick(object sender, AjaxEventArgs e)
        {
            ...
            string file = Server.MapPath("\\Upload\\Waybill\\" + this.hidFileName.Text);
            ...
            if (File.Exists(file))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                        ...
                        if (bll.Import(ds,hidFileName.Text))
                        {
