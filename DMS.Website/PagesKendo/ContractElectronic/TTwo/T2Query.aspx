<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageKendo/Site.Master" AutoEventWireup="true" CodeBehind="T2Query.aspx.cs" Inherits="DMS.Website.Pages.ContractKendo.TTwo.T2Query" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script src="../script/T2Query.js?v=3212"></script>
    <script>
