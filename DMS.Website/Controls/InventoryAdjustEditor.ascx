<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InventoryAdjustEditor.ascx.cs" Inherits="DMS.Website.Controls.InventoryAdjustEditor" %>
<%@ Register Assembly="Coolite.Ext.Web" Namespace="Coolite.Ext.Web" TagPrefix="ext" %>

<ext:Hidden ID="hiddenEditId" runat="server"></ext:Hidden>
<ext:Hidden ID="hiddenEditType" runat="server"></ext:Hidden>
                        ...
                        <ext:FormLayout ID="FormLayout1" runat="server">
                            ...
                            <ext:Anchor>
                                <ext:TextField 
                                    ID="txtCFN" 
                                    runat="server" 
                                    FieldLabel="<%$ Resources: resource,Lable_Article_Number  %>" 
                                    Width="150"
                                    ReadOnly="true" 
                                    Disabled="true"
                                    />
                            ...
                            <ext:Anchor>
                                <ext:TextField 
                                    ...
                                    >
                                    <Listeners>
                                        <Blur Handler="Coolite.AjaxMethods.UCE.CheckLotNumber();" />
                                    </Listeners>
                                </ext:TextField>
                            </ext:Anchor>
                            <ext:Anchor>
                            ...
                            <ext:Anchor>
                                <ext:DateField 
                                    ...
                                    runat="server" 
                                    Width="150" 
                                    FieldLabel="<%$ Resources:EditorWindow.txtCreatedDate.FieldLabel %>" 
                                    Format="yyyy-M-d"
                                    ReadOnly="true" 
                                    Disabled="true" 
                                    />
                            ...
                            <ext:Anchor>
                                <ext:NumberField ID="txtAdjustQty" Width="150" runat="server" AllowBlank="false" AllowDecimals="false" AllowNegative="false" FieldLabel="<%$ Resources:EditorWindow.txtAdjustQty.FieldLabel %>">
                                </ext:NumberField>
                            </ext:Anchor>
                        </ext:FormLayout>
                    </Body>                    
