<%@ Page Title="二级经销商订单申请" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="OrderApply.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Order.OrderApply" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/OrderApply.js?v=775<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
