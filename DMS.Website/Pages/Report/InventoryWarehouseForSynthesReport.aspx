<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryWarehouseForSynthesReport.aspx.cs" Inherits="DMS.Website.Pages.Report.InventoryWarehouseForSynthesReport" %>
                                    ...
                                    <ext:Panel ID="Panel2" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="80">
                                                ...
                                                <ext:Anchor>
                                                    <ext:TextField ID="tfWHMName" runat="server" FieldLabel="<%$ Resources: Panel1.tfWHMName.FieldLabel %>" ></ext:TextField>
                                                </ext:Anchor>
                                            </ext:FormLayout>
                                        </Body>
                                    </ext:Panel>
