...
/****** Object:  StoredProcedure [Workflow].[Proc_Contract_AppointmentT2_GetHtmlData]    Script Date: 2019/11/22 14:15:30 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT 'Contract_AppointmentT2' AS TemplateName,
	       'Main,Candidate,Documents,Competency,Proposals,CrossBu,SameDealer,FormerDealer,AssessmentDealer,Cfda,Display,DDReport' AS 
	       TableNames
