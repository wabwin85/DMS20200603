<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerCommercialSalesForLPReport.aspx.cs"
    Inherits="DMS.Website.Pages.Report.DealerCommercialSalesForLPReport" %>
                                    ...
                                    <ext:Panel ID="Panel2" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="80">
                                                ...
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbDealer" runat="server" EmptyText="<%$ Resources: Panel1.FormLayout3.cbDealer.EmptyText %>"
                                                        Width="230" Editable="true" TypeAhead="false" StoreID="DealerStore" ValueField="Id"
                                                        Resizable="true" Mode="Local" DisplayField="ChineseName" FieldLabel="<%$ Resources: Panel1.FormLayout3.cbDealer.FieldLabel %>">
                                                        <Triggers>
                                                            <ext:FieldTrigger Icon="Clear" Qtip="<%$ Resources: Panel1.FormLayout3.cbProductLine.FieldTrigger.Qtip %>" />
                                                        </Triggers>
                                                        <Listeners>
                                                ...
                                                <ext:Anchor>
                                                    <ext:TextField ID="txtCfnCode" runat="server" Width="150" FieldLabel="产品型号">
                                                    </ext:TextField>
                                                </ext:Anchor>
                                            </ext:FormLayout>
                                        </Body>
                                    ...
                                    <ext:Panel ID="Panel3" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="80">
                                                ...
                                                <ext:Anchor>
                                                    <ext:TextField ID="txtLotNumber" runat="server" Width="150" FieldLabel="批次">
                                                    </ext:TextField>
                                                </ext:Anchor>
                                            </ext:FormLayout>
                                        </Body>
                                    ...
                                    <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="80">
                                                ...
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbType" runat="server" EmptyText="<%$ Resources: Panel1.FormLayout3.cbType.EmptyText %>"
                                                        Width="150" Editable="false" TypeAhead="true" FieldLabel="<%$ Resources: Panel1.FormLayout3.cbType.FieldLabel %>">
                                                        <Items>
                                                            <ext:ListItem Text="正常采购" Value="1" />
                                                            <ext:ListItem Text="寄售销售" Value="2" />                                                          
                                                            <ext:ListItem Text="退换货" Value="3" />
                                                        </Items>
                                                        <Triggers>
                                                            <ext:FieldTrigger Icon="Clear" Qtip="<%$ Resources: Panel1.FormLayout3.cbProductLine.FieldTrigger.Qtip %>" />
                                                        </Triggers>
                        ...
                        <Body>
                            ...
                            <script language="javascript" type="text/javascript">
                                ...
                                function ResizeReport() {
                                    ...
                                    viewer.style.height = (htmlheight - 190) + "px";
                                }
