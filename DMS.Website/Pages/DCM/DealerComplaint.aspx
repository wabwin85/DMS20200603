<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerComplaint.aspx.cs" Inherits="DMS.Website.Pages.DCM.DealerComplaint" %>
...
<body>
    ...
    <div>
        ...
        <ext:Store ID="ResultStore" runat="server" AutoLoad="false" 
            OnRefreshData="ResultStore_RefreshData">
        ...
        <ext:Store ID="DealerComplaintStatusStore" runat="server" UseIdConfirmation="true" >
            <Reader>
        ...
        <ext:Store ID="DealerComplaintTypeStore" runat="server" UseIdConfirmation="true" >
            <Reader>
                <ext:JsonReader ReaderID="Key">
                    <Fields>
                        <ext:RecordField Name="Key" />
            ...
            <Body>
                <ext:BorderLayout ID="BorderLayout1" runat="server">
                    <North Collapsible="True" Split="True">
                        <ext:Panel ID="plSearch" runat="server" Title="<%$ Resources:plSearch.Title %>" 
                            Frame="True" AutoHeight="True"
                        Icon="Find" IDMode="Legacy">
                            <Body>
                                            ...
                                            <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="100">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbType" runat="server" EmptyText="<%$ Resources: plSearch.Panel4.cbType.EmptyText %>" Width="150" Editable="false" 
                                                        TypeAhead="true" Resizable="true" StoreID="DealerComplaintTypeStore" ValueField="Key" 
                                            ...
                                            <ext:FormLayout ID="FormLayout4" runat="server" LabelAlign="Left" LabelWidth="100">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbStatus" runat="server" EmptyText="<%$ Resources: plSearch.Panel5.cbStatus.EmptyText %>" Width="150" Editable="false" 
                                                        TypeAhead="true" Resizable="true" StoreID="DealerComplaintStatusStore" ValueField="Key" 
                            ...
                            <Buttons>
                                <ext:Button ID="btnSearch" Text="<%$ Resources:plSearch.btnSearch.Text %>" 
                                    runat="server" Icon="ArrowRefresh" IDMode="Legacy" CommandArgument="" 
                                    CommandName="" OnClientClick="">
                                    <Listeners>
                                        <Click Handler="#{GridPanel1}.reload();" />
                                    </Listeners>
                                </ext:Button>
                                <ext:Button ID="btnInsert" runat="server" 
                                    Text="<%$ Resources:plSearch.btnInsert.Text %>" Icon="Add" IDMode="Legacy" 
                                    CommandArgument="" CommandName="" OnClientClick="" >
                                    <Listeners>
                                        ...
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="Type" DataIndex="Type" Header="<%$ Resources: GridPanel1.Type.Header %>">
                                                    <Renderer Handler="return getNameFromStoreById(DealerComplaintTypeStore,{Key:'Key',Value:'Value'},value);" />
                                                </ext:Column>
                                                ...
                                                <ext:Column ColumnID="Status" DataIndex="Status" Header="<%$ Resources: GridPanel1.Status.Header %>">
                                                    <Renderer Handler="return getNameFromStoreById(DealerComplaintStatusStore,{Key:'Key',Value:'Value'},value);" />
                                                </ext:Column>
