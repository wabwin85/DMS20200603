...
{
    public class ChannelLogisticInfoWithQR301Downloader : DownloadData
    {
        string QrCode = "";

        public ChannelLogisticInfoWithQR301Downloader(string qrcode, string clientid)
        {
            QrCode = qrcode;
            this.ClientID = clientid;
            this.Type = DataInterfaceType.ChannelLogisticInfoWithQR301Downloader;
            this.LoadData += new EventHandler<DataEventArgs>(ChannelLogisticInfoWithQR301Downloader_LoadData);
        }

        void ChannelLogisticInfoWithQR301Downloader_LoadData(object sender, DataEventArgs e)
        {
