<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferEditorImport.aspx.cs" Inherits="DMS.Website.Pages.Transfer.TransferEditorImport" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var editId = '';
        var editControls = [
                          { name: 'WarehouseFrom', field: {xtype:"textfield",width:160,maxLength:50,allowBlank:false} },
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_TransferImport.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: GridPanel3.Title %>" StoreID="ResultStore" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="WarehouseFrom" DataIndex="WarehouseFrom" Header="<%$ Resources: GridPanel3.ColumnModel3.WarehouseFrom.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="WarehouseTo" DataIndex="WarehouseTo" Header="<%$ Resources: GridPanel3.ColumnModel3.WarehouseTo.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                ...
                                                <ext:Column ColumnID="TransferQty" DataIndex="TransferQty" Header="<%$ Resources: GridPanel3.ColumnModel3.TransferQty.Header %>" Sortable="false">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
