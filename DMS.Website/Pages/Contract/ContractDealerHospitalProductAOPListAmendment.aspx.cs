...
namespace DMS.Website.Pages.Contract
{
    ...
    public partial class ContractDealerHospitalProductAOPListAmendment : BasePage
    {
        ...
        public void AOPStore_RefershData(object sender, StoreRefreshDataEventArgs e)
        {
            try
            {
                ...
                DataTable dt = _contractMasterBll.QueryHospitalProductAOPAmendment(obj, start, limit, out totalCount).Tables[0];
                if (sender is Store)
                {
        ...
        public void AOPHospitalEditer_RefershData(object sender, StoreRefreshDataEventArgs e)
        {
            try
            {
                ...
                DataTable dt = _contractCommon.QueryHospitalProductAOPTemp(obj).Tables[0];
                if (sender is Store)
                {
                    Store store1 = (sender as Store);
                    store1.DataSource = dt;
        ...
        public void AOPDealerStore_RefershData(object sender, StoreRefreshDataEventArgs e)
        {
            try
            {
                ...
                DataTable dt = _contractCommon.GetAopDealerUnionHospitalUnitHistoryQuery(obj).Tables[0];
                if (sender is Store)
                {
                    Store store1 = (sender as Store);
                    (store1.Proxy[0] as DataSourceProxy).TotalCount = totalCount;
        ...
        protected void EditAop_Click(object sender, AjaxEventArgs e)
        {
            ...
            if (sellist != null && sellist.Length > 0)
            {
                ...
                this.txtReUnit_1.Value = aopdealers.ReferenceUnit_1.ToString();
                this.txtReUnit_2.Value = aopdealers.ReferenceUnit_2.ToString();
                this.txtReUnit_3.Value = aopdealers.ReferenceUnit_3.ToString();
                this.txtReUnit_4.Value = aopdealers.ReferenceUnit_4.ToString();
                this.txtReUnit_5.Value = aopdealers.ReferenceUnit_5.ToString();
                this.txtReUnit_6.Value = aopdealers.ReferenceUnit_6.ToString();
                this.txtReUnit_7.Value = aopdealers.ReferenceUnit_7.ToString();
                this.txtReUnit_8.Value = aopdealers.ReferenceUnit_8.ToString();
                this.txtReUnit_9.Value = aopdealers.ReferenceUnit_9.ToString();
                this.txtReUnit_10.Value = aopdealers.ReferenceUnit_10.ToString();
                this.txtReUnit_11.Value = aopdealers.ReferenceUnit_11.ToString();
                this.txtReUnit_12.Value = aopdealers.ReferenceUnit_12.ToString();

                this.txtFormalUnit_1.Value = aopdealers.FormalUnit_1.ToString();
                this.txtFormalUnit_2.Value = aopdealers.FormalUnit_2.ToString();
                this.txtFormalUnit_3.Value = aopdealers.FormalUnit_3.ToString();
                this.txtFormalUnit_4.Value = aopdealers.FormalUnit_4.ToString();
                this.txtFormalUnit_5.Value = aopdealers.FormalUnit_5.ToString();
                this.txtFormalUnit_6.Value = aopdealers.FormalUnit_6.ToString();
                this.txtFormalUnit_7.Value = aopdealers.FormalUnit_7.ToString();
                this.txtFormalUnit_8.Value = aopdealers.FormalUnit_8.ToString();
                this.txtFormalUnit_9.Value = aopdealers.FormalUnit_9.ToString();
                this.txtFormalUnit_10.Value = aopdealers.FormalUnit_10.ToString();
                this.txtFormalUnit_11.Value = aopdealers.FormalUnit_11.ToString();
                this.txtFormalUnit_12.Value = aopdealers.FormalUnit_12.ToString();
        ...
        protected void EditDealerAop_Click(object sender, AjaxEventArgs e)
        {
            ...
            if (sellist != null && sellist.Length > 0)
            {
                ...
                obj.Add("Year", year);
                VAopDealer aopdealers = _contractCommon.QueryDealerAOPAndHospitalAOPUnitTemp(obj);

                this.hidDealerProdLineId.Value = productLineBumId.ToString();
                this.hidDealerAopYear.Value = aopdealers.Year.ToString();
                this.txtDealerAopYear.Text = aopdealers.Year.ToString();
                ...
                this.txtFormalDealerAmount_1.Value = aopdealers.FormalAmount1.ToString();
                this.txtFormalDealerAmount_2.Value = aopdealers.FormalAmount2.ToString();
                this.txtFormalDealerAmount_3.Value = aopdealers.FormalAmount3.ToString();
                this.txtFormalDealerAmount_4.Value = aopdealers.FormalAmount4.ToString();
                this.txtFormalDealerAmount_5.Value = aopdealers.FormalAmount5.ToString();
                this.txtFormalDealerAmount_6.Value = aopdealers.FormalAmount6.ToString();
                this.txtFormalDealerAmount_7.Value = aopdealers.FormalAmount7.ToString();
                this.txtFormalDealerAmount_8.Value = aopdealers.FormalAmount8.ToString();
                this.txtFormalDealerAmount_9.Value = aopdealers.FormalAmount9.ToString();
                this.txtFormalDealerAmount_10.Value = aopdealers.FormalAmount10.ToString();
                this.txtFormalDealerAmount_11.Value = aopdealers.FormalAmount11.ToString();
                this.txtFormalDealerAmount_12.Value = aopdealers.FormalAmount12.ToString();
        ...
        private void SetInitialValue()
        {
            ...
            //this.hidBeginYearMinMonth.Text = Convert.ToString(Convert.ToDateTime(this.HidEffectiveDate.Text).Day > 15 ? Convert.ToDateTime(this.HidEffectiveDate.Text).Month + 1 : Convert.ToDateTime(this.HidEffectiveDate.Text).Month);
            int amandDate = (_contractMasterBll.GetAmandCurrentJudgeDate().Equals("") ? 15 : Convert.ToInt32(_contractMasterBll.GetAmandCurrentJudgeDate().ToString()));
            this.hidBeginYearMinMonth.Text = Convert.ToString(Convert.ToDateTime(this.HidEffectiveDate.Text).Day <= amandDate ? Convert.ToDateTime(this.HidEffectiveDate.Text).Month : Convert.ToDateTime(this.HidEffectiveDate.Text).Month + 1);
        }
