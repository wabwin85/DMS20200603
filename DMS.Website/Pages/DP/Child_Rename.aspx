<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Child_Rename.aspx.cs" Inherits="DMS.Website.Pages.DP.Child_Rename" %>
...
<body>
    ...
    <ext:Store ID="Store_Rename" runat="server" UseIdConfirmation="true" OnRefreshData="Rename_RefershData"
        AutoLoad="true" >
    ...
    <ext:Store ID="StoreRenameType" runat="server" AutoLoad="true" UseIdConfirmation="true"
        OnRefreshData="Store_RenameTypeRefresh">
        <Proxy>
            <ext:DataSourceProxy />
        </Proxy>
        <Reader>
    ...
    <ext:TabPanel ID="TabPanel1" runat="server" Height="450" Border="false">
        <Tabs>
            <ext:Tab ID="Tab1" Hidden="true" runat="server" Title="更名记录" Border="false" BodyStyle="background-color: #D9E7F8;">
                <Body>
                                        ...
                                        <ext:Panel ID="plSearch" runat="server" Header="false" Frame="true" AutoHeight="true"
                                                        ...
                                                        <ext:Panel ID="Panel16" runat="server" Border="false">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout4" runat="server" LabelAlign="Left" LabelWidth="90">
                                                                    <ext:Anchor>
                                                                        <ext:TextField ID="tfOldname" runat="server" FieldLabel="现用名称" Width="150" />
                                                                    </ext:Anchor>
                                                                </ext:FormLayout>
                                                            </Body>
                                                        </ext:Panel>
                                                        ...
                                                        <ext:Panel ID="Panel1" runat="server" Border="false">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="90">
                                                                    <ext:Anchor>
                                                                         <ext:TextField ID="tfNewname" runat="server" FieldLabel="曾用名称" Width="150" />
                                                                    </ext:Anchor>
                                                                </ext:FormLayout>
                                                            </Body>
                                                        </ext:Panel>
                                                        ...
                                                        <ext:Panel ID="Panel20" runat="server" Border="false">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout6" runat="server" LabelAlign="Left" LabelWidth="100">
                                                                    <ext:Anchor>
                                                                        <ext:ComboBox ID="cbRenameType" runat="server" TypeAhead="true" Mode="Local" ForceSelection="true"
                                                                            FieldLabel="更名类型" TriggerAction="All" ValueField="Type" DisplayField="Type" StoreID="StoreRenameType">
                                                                            <Triggers>
                                            ...
                                            <Buttons>
                                                <ext:Button ID="btnSearch" Text="查询" runat="server" Icon="ArrowRefresh" IDMode="Legacy">
                                                    <Listeners>
                                                        <Click Handler="#{GridPanel_Rename}.reload();" />
                                                    </Listeners>
                                                </ext:Button>
                                            </Buttons>
                                        </ext:Panel>
                                        ...
                                        <ext:Panel runat="server" ID="ctl46" Border="false" Frame="false">
                                            <Body>
                                                <ext:FitLayout ID="FitLayout9" runat="server">
                                                    <ext:GridPanel ID="GridPanel_Rename" runat="server" Title="查询结果" Header="false" StoreID="Store_Rename"
                                                        Border="false">
                                                        <ColumnModel ID="ColumnModel9" runat="server">
                                                            <Columns>
                                                                <ext:Column ColumnID="Column1" DataIndex="Column1" Header="现用名称">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column2" DataIndex="Column2" Header="曾用名称">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column3" DataIndex="Column3" Header="更名时间">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column4" DataIndex="Column4" Header="部门">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column5" DataIndex="Column5" Header="更名类型">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column6" DataIndex="Column6" Header="备注说明">
                                                                </ext:Column>
                                                            </Columns>
                                                        </ColumnModel>
                                                        <SelectionModel>
