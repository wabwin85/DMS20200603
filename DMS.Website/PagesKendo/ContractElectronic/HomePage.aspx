<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="DMS.Website.Pages.ContractKendo.HomePage" %>
...
<body style="margin: 0px; height: 100%; padding: 0px;">
    <div class="container">
        <div style="background-color: transparent;">
                ...
                <table class="headerTable">
                    <tr style="background-color: #003b6f; filter: progid:DXImageTransform.Microsoft.Gradient(startColorStr='#003b6f',endColorStr='#8BA9C5',gradientType='1'); background: -moz-linear-gradient(left, #003b6f, #8BA9C5); background: -o-linear-gradient(left,#003b6f, #8BA9C5); background: -webkit-gradient(linear, 0% 0%, 100% 0%, from(#003b6f), to(#8BA9C5));">
                        <td style="width: 60%; height: 48px;">
                            ...
                            <span style="font-size: 20px; color: #FFFFFF; margin-top: 10px; vertical-align: middle;">&nbsp;&nbsp;蓝威电子合同管理系统</span>
                        </td>
                        <td style="text-align: right; width: 40%; float: right; vertical-align: middle;">
                            <div class="setting">
                                <ul>
                                    <li>
                                        <label style="margin-right: 8px; color: #FFFFFF; font-weight: normal; padding-top: 5px;" id="IptUserName">GrapeCity</label>
                                    </li>
                                </ul>
                            </div>
                        </td>
            ...
            <div>
                <ul id="menu" style="border-color: #337ab7; padding: 1px 10px 1px 10px;">
                </ul>
            </div>
        </div>
