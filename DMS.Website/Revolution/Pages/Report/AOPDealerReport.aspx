<%@ Page Title="经销商指标达成报表" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="AOPDealerReport.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Report.AOPDealerReport" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/AOPDealerReport.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            AOPDealerReport.Init();
        });
    </script>
</asp:Content>
