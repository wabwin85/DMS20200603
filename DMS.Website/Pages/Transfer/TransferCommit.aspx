<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferCommit.aspx.cs"
    Inherits="DMS.Website.Pages.Transfer.TransferCommit" %>
...
<head>
    ...
    <script language="javascript">       
        ...
        var CheckAddItemsParam = function() {
            ...
            if(Ext.getCmp('cbDealerFromWin').getValue() == Ext.getCmp('hiddenDealerToId').getValue()){
                Ext.getCmp('AddItemsButton').disable();
                }
                else {
        ...
        var CheckLotQty = function() {
            ...
            for (var i = 0; i < store.getCount(); i++) {
                ...
                {
                    Ext.Msg.alert('<%=GetLocalResourceObject("CheckLotQty.Alert.Title").ToString()%>', '库存调拨为NQR的必须填写二维码');
                    return false;
                }
                 if(record.data.QRCodeEdit!=null &&  record.data.QRCodeEdit != '' && record.data.TransferQty>1)
                   ...
                   if(record.data.QRCodeEdit!='' && store.query("QRCodeEdit",record.data.QRCodeEdit).length>1)
                   {
...
<body>
    ...
    <ext:Store ID="DealerToStore" runat="server" UseIdConfirmation="true">
        <Reader>
            <ext:JsonReader ReaderID="Id">
                <Fields>
                    <ext:RecordField Name="Id" />
    ...
    <ext:Store ID="WarehouseStore" runat="server" UseIdConfirmation="true" OnRefreshData="WarehouseStore_RefreshData"
        AutoLoad="false">
        <Reader>
            <ext:JsonReader ReaderID="Id">
                <Fields>
    ...
    <ext:Hidden ID="hidInitDealerFromId" runat="server" />
    <ext:Hidden ID="hidInitDealerToId" runat="server">
    </ext:Hidden>
                                            ...
                                            <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbDealerFrom" runat="server" EmptyText="<%$ Resources: Panel1.FormLayout2.cbDealerFrom.EmptyText %>"
                                                        ...
                                                        ValueField="Id" DisplayField="ChineseName" FieldLabel="<%$ Resources: Panel1.FormLayout2.cbDealerFrom.FieldLabel %>"
                                                        ListWidth="300" Resizable="true">
                                                        <Triggers>
                                            ...
                                            <ext:FormLayout ID="FormLayout3" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbDealerTo" runat="server" EmptyText="<%$ Resources: Panel1.FormLayout3.cbDealerTo.EmptyText %>"
                                                        ...
                                                        ValueField="Id" DisplayField="ChineseName" FieldLabel="<%$ Resources: GridPanel1.ColumnModel1.ToDealerDmaName.Header %>"
                                                        ListWidth="300" Resizable="true">
                                                        <Triggers>
                            ...
                            <ext:Button ID="btnInsert" runat="server" Text="<%$ Resources: Panel1.btnInsert.Text %>"
                                ...
                                <AjaxEvents>
                                    <Click Before="#{GridPanel1}.getSelectionModel().clearSelections();" OnEvent="ShowDetails"
                                        ...
                                        Success="#{cbDealerFromWin}.clearValue();#{cbDealerToWin}.clearValue();#{cbProductLineWin}.setValue(#{cbProductLineWin}.store.getTotalCount()>0?#{cbProductLineWin}.store.getAt(0).get('Id'):'');#{hiddenProductLineId}.setValue(#{cbProductLineWin}.getValue());ClearItems();#{GridPanel2}.clear();#{hiddenIsModified}.setValue('new');#{gpLog}.store.reload();">
                                ...
                                <ext:GridPanel ID="GridPanel1" runat="server" Title="<%$ Resources: GridPanel1.Title %>"
                                    ...
                                    <AjaxEvents>
                                        <Command OnEvent="ShowDetails" Failure="Ext.MessageBox.alert(MsgList.ShowDetails.FailureTitle, MsgList.ShowDetails.FailureMsg);"
                                            Success="#{cbDealerFromWin}.clearValue();#{cbDealerFromWin}.setValue(#{hiddenDealerFromId}.getValue());#{cbDealerToWin}.clearValue();#{cbDealerToWin}.setValue(#{hiddenDealerToId}.getValue());#{cbProductLineWin}.clearValue(); #{cbProductLineWin}.setValue(#{hiddenProductLineId}.getValue());CheckAddItemsParam();ClearItems();#{GridPanel2}.reload();#{hiddenIsModified}.setValue('old');#{gpLog}.store.reload();">
                                            <EventMask ShowMask="true" Target="CustomTarget" CustomTarget="={#{GridPanel1}.body}" />
                                            <ExtraParams>
                                            ...
                                            <ext:FormLayout ID="FormLayout5" runat="server" LabelAlign="Left" LabelWidth="80">
                                                ...
                                                <ext:Anchor>
                                                    <ext:ComboBox ID="cbDealerToWin" runat="server" Width="200" Editable="true" Mode="Local"
                                                        TypeAhead="true" StoreID="DealerStore" ValueField="Id" DisplayField="ChineseName"
                                                        FieldLabel="<%$ Resources: DetailWindow.FormLayout5.txtDealerToWin.FieldLabel %>"
                                ...
                                <Body>
                                    <ext:FitLayout ID="FitLayout2" runat="server">
                                        <ext:GridPanel ID="GridPanel2" runat="server" Title="<%$ Resources: GridPanel2.Title %>"
                                            ...
                                            EnableHdMenu="false" Header="false" AutoExpandColumn="WarehouseName">
                                            <TopBar>
                                            ...
                                            <ColumnModel ID="ColumnModel2" runat="server">
                                                <Columns>
                                                    ...
                                                    <ext:Column ColumnID="UPN" DataIndex="UPN" Header="<%$ Resources: GridPanel2.ColumnModel2.UPN.Header %>"
                                                        Hidden="<%$ AppSettings: HiddenUPN  %>" Width="140">
                                                    </ext:Column>
                                                    ...
                                                    <ext:CommandColumn Width="50" Align="Center">
                                                        <Commands>
                                            ...
                                            <Listeners>
                                                ...
                                                #{hiddenlotNumber}.setValue(this.getSelectionModel().getSelected().data.LotNumber);
                                                 ...
                                                 " />
                                                <AfterEdit Handler="Coolite.AjaxMethods.SaveItem(#{hiddenCurrentEdit}.getValue(),#{cboToWarehouseId}.getValue(), #{txtQty}.getValue(), #{hiddenQrCode}.getValue(),#{txtQrCode}.getValue(),#{hiddenlotNumber}.getValue(),{success:function(){#{hiddenIsEditting}.setValue('');},failure: function(err) {Ext.Msg.alert('Failure', err);}});" />
                                            </Listeners>
                                        </ext:GridPanel>
                                    </ext:FitLayout>
                                </Body>
