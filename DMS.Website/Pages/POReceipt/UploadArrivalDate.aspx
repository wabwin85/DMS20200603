<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadArrivalDate.aspx.cs"
    Inherits="DMS.Website.Pages.POReceipt.UploadArrivalDate" %>
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_ArrivalDate.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                        ...
                        <ext:Panel ID="Panel9" runat="server" Height="300" Header="false">
                            <Body>
                                <ext:FitLayout ID="FitLayout3" runat="server">
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: DownloadButton.Text %>" StoreID="Store1" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="ArrivalDate" DataIndex="ArrivalDate" Header="<%$ Resources: GridPanel3.ColumnModel3.ArrivalDate.Header %>">
                                                </ext:Column>
