<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormalDealerHospitalProductAOP.aspx.cs"
    Inherits="DMS.Website.Pages.Contract.FormalDealerHospitalProductAOP" %>
        ...
        <ext:ViewPort ID="ViewPort1" runat="server">
            <Body>
                <ext:BorderLayout ID="BorderLayout1" runat="server">
                    ...
                    <Center>
                        <ext:Panel runat="server" ID="ctl46" Border="false" Frame="true" Title="经销商医院产品分类指标列表"
                            Icon="HouseKey">
                            <Body>
                                <ext:FitLayout ID="FitLayout1" runat="server">
                                    <ext:GridPanel ID="GridPanel1" runat="server" Header="false" StoreID="AOPStore" Border="false"
                                        Icon="Lorry" AutoExpandColumn="ProductClassName" AutoExpandMax="250" AutoExpandMin="150"
                                        StripeRows="true">
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                <ext:Column ColumnID="HospitalName" DataIndex="HospitalName" Header="医院">
                                                </ext:Column>
                                                <ext:Column ColumnID="ProductClassName" DataIndex="ProductClassName" Header="产品分类">
                                                </ext:Column>
                                                <ext:Column ColumnID="Year" DataIndex="Year" Header="年度">
                                                </ext:Column>
                                                <ext:Column ColumnID="Unit_Y" DataIndex="Unit_Y" Header="合计">
