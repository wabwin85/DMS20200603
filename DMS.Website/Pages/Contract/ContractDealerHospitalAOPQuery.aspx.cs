...
namespace DMS.Website.Pages.Contract
{
    ...
    public partial class ContractDealerHospitalAOPQuery : BasePage
    {
        ...
        public void AOPStore_RefershData(object sender, StoreRefreshDataEventArgs e)
        {
            try
            {
                ...
                DataTable dt = _contractCommon.QueryHospitalProductAmountTemp2(obj, start, limit, out totalCount).Tables[0];
                if (sender is Store)
                {
        ...
        public void AOPDealerStore_RefershData(object sender, StoreRefreshDataEventArgs e)
        {
            try
            {
                ...
                DataTable dt = _contractMasterBll.GetAopDealersByHosTempQuery(obj).Tables[0];
                if (sender is Store)
                {
                    Store store1 = (sender as Store);
                    (store1.Proxy[0] as DataSourceProxy).TotalCount = totalCount;
