...
{
    public partial class OrderImport : BasePage
    {
        ...
        [AjaxMethod]
        public void Save(string id, string orderType, string articleNumber, string requiredQty, string lotNumber, string productLine)
        {
