...
Values('Menu',2,'区域维护',(select menuid from lafite_sitemap where menutitle like '%信息维护|System%'),0,'~/Revolution/Pages/MasterDatas/TerritoryList.aspx',
1,'M2_TerritoryList',90,'admin',GetDate())
...
Values(newid(),(Select PowerKey From lafite_sitemap WHERE MenuType='Menu' AND MenuTitle='区域维护'),
'区域维护','',0,'','Menu',1,'4028931b0f0fc135010f0fc1356a0001',0,'admin',GetDate(),
'admin',GetDate())
...
Values(newid(),'','','区域维护',1,'','4028931b0f0fc135010f0fc1356a0001',0,
...
Values(newid(),(Select id from lafite_STRATEGY where strategy_name='区域维护'),
'Function',(select id from Lafite_Function where Function_Name='区域维护'),0,
...
,'STRATEGY',(Select id from lafite_STRATEGY where strategy_name='区域维护'),
