<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LPSalesForBscReport.aspx.cs" Inherits="DMS.Website.Pages.Report.LPSalesForBscReport" %>
                                    ...
                                    <ext:Panel ID="Panel3" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="120">
                                                <ext:Anchor>
                                                    <ext:DateField ID="txtStartDate" runat="server" Width="150" FieldLabel="开始时间" />
                                                </ext:Anchor>
                                                <ext:Anchor>
                                    ...
                                    <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                        <Body>
                                            <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="120">
                                                <ext:Anchor>
                                                    <ext:DateField ID="txtEndDate" runat="server" Width="150" FieldLabel="结束时间" />
                                                </ext:Anchor>
                                                <ext:Anchor>
                        ...
                        <Body>
                            ...
                            <script language="javascript" type="text/javascript">
                                ...
                                function ResizeReport() {
                                    ...
                                    viewer.style.height = (htmlheight - 180) + "px";
                                }
