...
CfnSetList = function () {
    ...
    var business = 'MasterDatas.CfnSetList';
    var pickedList = [];
    ...
    that.Init = function () {
        ...
        FrameUtil.SubmitAjax({
            ...
            callback: function (model) {
                ...
                $('#QryCFNSetUPN').FrameTextBox({

                    value: model.QryCFNSetUPN
                });
    ...
    that.openInfo = function (InstanceId) {
        ...
        top.createTab({
            id: 'M_' + InstanceId,
            title: '明细信息',
            url: 'Revolution/Pages/MasterDatas/CfnSetInfo.aspx?InstanceId=' + param,
            refresh: true
        });
    }
