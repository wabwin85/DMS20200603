...
namespace DMS.Website.Pages.Report
{
    ...
    public partial class DealerInventoryHistoryForSynthesReport : BasePage
    {
        ...
        protected void initReportView()
        {
            ...
            serverReport.ReportPath = CommonVariable.ReportPath_DealerHistoryInvDetailForSynthesReport;
