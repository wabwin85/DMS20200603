<%@ Page Title="销售指标达成报表" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="SalesAOP.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Report.SalesAOP" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/SalesAOP.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
