DROP VIEW [dbo].[V_AOPICDealerHospital_Temp]
GO
...
CREATE VIEW [dbo].[V_AOPICDealerHospital_Temp]
AS
select AOPICH_Contract_ID,AOPICH_DMA_ID,AOPICH_ProductLine_ID,AOPICH_PCT_ID,AOPICH_Hospital_ID,AOPICH_Year,
			 sum(case
       ...
       from AOPICDealerHospitalTemp(nolock)
       group by AOPICH_Contract_ID,AOPICH_DMA_ID,AOPICH_ProductLine_ID,AOPICH_PCT_ID,AOPICH_Hospital_ID,AOPICH_Year
