DROP PROCEDURE [dbo].[GC_AutoUpdateMasterData_CFN] 
GO

CREATE PROCEDURE [dbo].[GC_AutoUpdateMasterData_CFN] 
...
AS
   ...
   BEGIN TRY
      ...
      update TCFN
      SET TCFN.UPN_ChineseName=SCFN.[Prod Name Chinese],
          TCFN.UPN_EnglishName = SCFN.MaterialDescription,
          TCFN.Level5Code= SCFN.LVL5CODE,
          TCFN.Level5Desc= SCFN.LVL5DESC,
          TCFN.Level4Code= SCFN.LEVEL4CODE,
          TCFN.Level4Desc= SCFN.LVL4DESC,
          TCFN.Level3Code= SCFN.LVL3CODE,
          TCFN.Level3Desc= SCFN.LEVEL3DESC,
          TCFN.Level2Code= SCFN.LEVEL2CODE,
          TCFN.Level2Desc= SCFN.LEVEL2DESC,
          TCFN.Level1Code= SCFN.LEVEL1CODE,
          TCFN.Level1Desc= SCFN.LEVEL1DESC,
          TCFN.ProductLine_ID= SCFN.ProductLineID,
          TCFN.DivisionID= SCFN.DivisionID,
          TCFN.Division= SCFN.Division,
          TCFN.UPN_Description= SCFN.MaterialDescription,
          TCFN.SFDA= SCFN.[Reg Number],
          TCFN.Sheet= SCFN.Sheets,
          TCFN.ST= 1,
          TCFN.MMPP= SCFN.MMPP,
          TCFN.DChain= SCFN.SalesStatus,
          TCFN.UOM= '盒'
	  ...
	  --Special 
      update interface.T_I_QV_CFN set DivisionID=32, Division='EP', ProductLine_ID='8DE26929-588B-4E24-9DCD-A26200A9D56B' WHERE UPN IN ('EPSYSCARTCHN','EPSYSCARTCHN1')
      update CFN set CFN_ProductLine_BUM_ID ='f45edda4-35f0-4dac-8063-a26200a96931' WHERE CFN_CustomerFaceNbr IN ('EPSYSCARTCHN','EPSYSCARTCHN1')
    ...
    update cfn set CFN_Property4=-1,CFN_Property8='参数设置不在同步逻辑内, 请复核' where CFN_CustomerFaceNbr not in (
		...
		)  and CFN_CustomerFaceNbr not in ('91157375-01','91157375-02','91157375-03','91157375-04','72400271','M0042003990','M004RH31400','M00420011800','M00420012300','M00420020300','M00420014130')
    ...
    update cfn set CFN_Property4=1, CFN_Property8='无注册证产品，仅供样品管理使用'
    where CFN_CustomerFaceNbr in (select upn from Tmp_Product_NoTendringInfoUPN_ForSampleUse)
    ...
    --临床样品特殊处理
    update cfn set CFN_Property4 = 1 where CFN_Property5='临床样品 - 暂无注册证'
