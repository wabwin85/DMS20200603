 ...
 * Created Time: 2014/1/14 10:53:27
 *
...
namespace DMS.Model
{
    ...
    /// </summary>
    [Serializable]
    public class PurchaseOrderInit : BaseModel
    {
        #region Private Members 26
        ...
        private string _PointType_ErrMsg;
        #endregion
        ...
        {
            get { return _PointTypeCode; }
            set
            {
                if (value != null && value.Length > 100)
                    throw new ArgumentOutOfRangeException("Invalid value for PointTypeCode", value, value.ToString());

                _PointTypeCode = value;
            }
        }
        ...
        {
            get { return _PointType_ErrMsg; }
            set
            {
                if (value != null && value.Length > 100)
                    throw new ArgumentOutOfRangeException("Invalid value for PointType_ErrMsg", value, value.ToString());

                _PointType_ErrMsg = value;
            }
        }
        #endregion
