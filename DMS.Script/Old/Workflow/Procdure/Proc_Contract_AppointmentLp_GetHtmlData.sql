...
DROP PROCEDURE [Workflow].[Proc_Contract_AppointmentLp_GetHtmlData]
GO


CREATE PROCEDURE [Workflow].[Proc_Contract_AppointmentLp_GetHtmlData]
	@InstanceId UNIQUEIDENTIFIER
AS
BEGIN
	--Template & Tables
	SELECT 'Contract_AppointmentLp' AS TemplateName,
	       'Main,Candidate,Documents,Competency,Proposals,Justification,PreContract,Quota,Service,CrossBu,SameDealer,FormerDealer,AssessmentDealer,Cfda,Display' AS 
	       TableNames
