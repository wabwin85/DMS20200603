DROP VIEW [dbo].[V_ConsignmentDelayApplyForm]
GO
...
CREATE VIEW [dbo].[V_ConsignmentDelayApplyForm]
AS
	SELECT CAH_ID AS 'Id',
	...
	'短期寄售延期申请单' AS '单据类型',
	CAH_OrderNo AS '申请单号',
	CONVERT(NVARCHAR(20),CAH_Delay_SubmitDate,120) AS '提交时间',
	(SELECT VALUE1 FROM Lafite_DICT(nolock) WHERE DICT_TYPE = 'CONST_Delay_Status' AND DICT_KEY = CAH_Delay_OrderStatus ) AS '单据状态',
