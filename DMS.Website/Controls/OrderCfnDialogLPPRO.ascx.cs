...
{
    [AjaxMethodProxyID(IDMode = AjaxMethodProxyIDMode.Alias, Alias = "OrderCfnDialogLPPRO")]
    public partial class OrderCfnDialogLPPRO : BaseUserControl
    {
        ...
        protected void CurrentCfnStore_RefershData(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            //获取产品
            DataSet ds = business.QueryCfnForPurchaseOrderByPRO(param, (e.Start == -1 ? 0 : e.Start), (e.Limit == -1 ? this.PagingToolBar2.PageSize : e.Limit), out totalCount);
