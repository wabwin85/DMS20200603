<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryAdjustImport.aspx.cs" Inherits="DMS.Website.Pages.Inventory.InventoryAdjustImport" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var editId = '';
        var editControls = [
                          { name: 'QrCode', field: { xtype: "textfield", width: 160, maxLength: 50, allowBlank: false } },
                          { name: 'SAPCode', field: { xtype: "textfield", width: 160, maxLength: 50, allowBlank: false } },
                          { name: 'ChineseName', field: {xtype:"textfield",width:160,maxLength:100,allowBlank:false} },
                          { name: 'Warehouse', field: {xtype:"textfield",width:160,maxLength:50,allowBlank:false} },
                          { name: 'ArticleNumber', field: {xtype:"textfield",width:100,maxLength:50,allowBlank:false} },
                          { name: 'LotNumber', field: {xtype:"textfield",width:70,maxLength:50,allowBlank:false} },
                          { name: 'ReturnQty', field: {xtype:"numberfield",width:90,allowBlank:false,minValue:1.0,maxValue:99999999.0,allowNegative:false,allowDecimals:false,inputType:"text"} },
                          { name: 'AdjustType', field: {xtype:"textfield",width:100,maxLength:50,allowBlank:false} }
                        ];
        ...
        var rowCommand = function(command, record, row){
            if (command == "Edit"){
                ...
                var tbReturnQty = Ext.getCmp('tbReturnQty');
                var tbLotNumber = Ext.getCmp('tbLotNumber');
                var tbAdjustType = Ext.getCmp('tbAdjustType');
                ...
                if (checkValid())
                {
                    Coolite.AjaxMethods.Save(
                        ...
                        tbReturnQty.getValue(),
                        tbLotNumber.getValue(),
                        tbAdjustType.getValue(),
                        tbSAPCode.getValue(),
                        tbQrCode.getValue(),
                        {
                            success: function(){
            ...
            <Reader>
                <ext:JsonReader ReaderID="Id">
                    <Fields>
                        ...
                        <ext:RecordField Name="AdjustType" />
                        <ext:RecordField Name="ChineseNameErrMsg"/>
                        <ext:RecordField Name="WarehouseErrMsg"/>
                        <ext:RecordField Name="ArticleNumberErrMsg" />
                        <ext:RecordField Name="LotNumberErrMsg" />
                        <ext:RecordField Name="ReturnQtyErrMsg" />
                        <ext:RecordField Name="AdjustTypeErrMsg" />
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_Adjust.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: GridPanel3.Title %>" StoreID="ResultStore" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="SAPCode" DataIndex="SAPCode" Header="经销商编号" Sortable="false">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="ChineseName" DataIndex="ChineseName" Header="<%$ Resources: GridPanel3.ColumnModel3.ChineseName.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="Warehouse" DataIndex="Warehouse" Header="<%$ Resources: GridPanel3.ColumnModel3.Warehouse.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                ...
                                                <ext:Column ColumnID="LotNumber" DataIndex="LotNumber" Header="<%$ Resources: GridPanel3.ColumnModel3.LotNumber.Header %>" Sortable="false" Width="150px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="QrCode" DataIndex="QrCode" Header="二维码" Sortable="false" Width="150px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="ReturnQty" DataIndex="ReturnQty" Header="<%$ Resources: GridPanel3.ColumnModel3.ReturnQty.Header %>" Sortable="false">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
                                                <ext:Column ColumnID="AdjustType" DataIndex="AdjustType" Header="<%$ Resources: GridPanel3.ColumnModel3.AdjustType.Header  %>" Sortable="false" Width="100px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
