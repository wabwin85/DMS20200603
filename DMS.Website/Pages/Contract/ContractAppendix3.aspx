<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractAppendix3.aspx.cs"
    Inherits="DMS.Website.Pages.Contract.ContractAppendix3" %>
...
<body>
    ...
    <ext:Hidden ID="hdDivisionName" runat="server">
    </ext:Hidden>
            ...
            <TopBar>
                <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <ext:Button ID="btnCreatePdf" runat="server" Text="生成Appendix3 PDF" Icon="PageWhiteAcrobat"
        ...
        <ext:Panel ID="plAppendix1" runat="server" Header="true" Title="For Requestor:   Please Complete Section 1 - 3"
            ...
            <Body>
                                        ...
                                        <ext:Panel ID="Panel7" runat="server" Border="false">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout4" runat="server" LabelWidth="150">
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfDealerName" runat="server" FieldLabel="Dealer Name" Width="550"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                </ext:FormLayout>
                ...
                <ext:Panel ID="Panel18" runat="server" AutoHeight="true" FormGroup="true" BodyBorder="true"
                    Title="3.  Agreement Renewal Proposals">
                    <Body>
                                        ...
                                        <ext:Panel ID="Panel10" runat="server" Border="false">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout3" runat="server" LabelWidth="150">
                                                    <ext:Anchor>
                                                        <ext:Label ID="lb" runat="server" FieldLabel="Contract Type">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label1" runat="server" FieldLabel="BSC Entity">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label2" runat="server" FieldLabel="Exclusiveness">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label3" runat="server" FieldLabel="Agreement Term">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label4" runat="server" FieldLabel="Prices">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label5" runat="server" FieldLabel="Special Sales Program">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label6" runat="server" FieldLabel=" Payment Term">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label7" runat="server" FieldLabel=" Credit Limits">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label8" runat="server" FieldLabel="Security Deposit">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:Label ID="Label9" runat="server" FieldLabel="Product Line">
                                                        </ext:Label>
                                                    </ext:Anchor>
                                                </ext:FormLayout>
                                            </Body>
                                        ...
                                        <ext:Panel ID="Panel13" runat="server" Border="false">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout7" runat="server" LabelWidth="170">
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfContractTypeOld" runat="server" Width="150" FieldLabel="Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfBSCEntityOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfExclusivenessOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfAgreementTermOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfPricesOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfSpecialSalesOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfPaymentTermOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfCreditLimitsOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfSecurityDepositOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfProductLineOld" runat="server" Width="150" FieldLabel=" Current Agreement Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                </ext:FormLayout>
                                        ...
                                        <ext:Panel ID="Panel14" runat="server" Border="false">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout8" runat="server" LabelWidth="130">
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfContractTypeNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfBSCEntityNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfExclusivenessNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfAgreementTermNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfPricesNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfSpecialSalesNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfPaymentTermNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfCreditLimitsNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfSecurityDepositNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfProductLineNew" runat="server" Width="150" FieldLabel=" Renewal Term"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                </ext:FormLayout>
                                        ...
                                        <ext:Panel ID="Panel15" runat="server" Border="false">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout9" runat="server" LabelWidth="130">
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfContractTypeRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfBSCEntityRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfExclusivenessRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfAgreementTermRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfPricesRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfSpecialSalesRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfPaymentTermRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfCreditLimitsRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                                                        <ext:TextField ID="tfSecurityDepositRemarks" runat="server" Width="150" FieldLabel=" Remarks"
                                                            ReadOnly="true">
                                                        </ext:TextField>
                                                    </ext:Anchor>
                                                    <ext:Anchor>
                        ...
                        <ext:Panel ID="Panel46" runat="server" Border="false">
                            <Body>
                                <ext:FormLayout ID="FormLayout24" runat="server" LabelWidth="500">
                                    <ext:Anchor>
                                        <%--<ext:Checkbox ID="cbTerritory" runat="server" BoxLabel="Territory (Hospitals)" HideLabel="true"
                                            ReadOnly="true">
                                        </ext:Checkbox>--%>
                                        <ext:Label ID="lbTerritory" runat="server" FieldLabel="Territory (Hospitals)">
                                        </ext:Label>
                                    </ext:Anchor>
                                </ext:FormLayout>
                            </Body>
                            ...
                            <Body>
                                <ext:ColumnLayout ID="ColumnLayout10" runat="server">
                                    <ext:LayoutColumn ColumnWidth=".5">
                                        <ext:Panel ID="Panel30" runat="server" Border="true" Height="400" AutoScroll="true">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout14" runat="server">
                                                    <ext:Anchor>
                                                        <ext:GridPanel ID="gpTerritoryOld" runat="server" StoreID="TerritoryOld" Border="true"
                                                            Height="398" AutoScroll="true" Icon="Lorry" StripeRows="true" Width="500" Title="Original Agreement Term">
                                                    ...
                                                    <ext:Anchor>
                                                        <ext:GridPanel ID="gpAreaOld" runat="server" StoreID="AreaStoreOld" Border="true"
                                                            Hidden="true" AutoScroll="true" Height="150" Icon="Lorry" StripeRows="true" Title="Original Agreement Term">
                                                    ...
                                                    <ext:Anchor>
                                                        <ext:GridPanel ID="gpExcludeHosOld" runat="server" StoreID="ExcludeHospitalStoreOld"
                                                            Hidden="true" Border="true" AutoScroll="true" Height="248" Icon="Lorry" StripeRows="true"
                                    ...
                                    <ext:LayoutColumn ColumnWidth=".5">
                                        <ext:Panel ID="Panel32" runat="server" Border="true" Height="400" AutoScroll="true">
                                            <Body>
                        ...
                        <ext:Panel ID="Panel33" runat="server">
                            <Body>
                                <ext:ColumnLayout ID="ColumnLayout11" runat="server">
                                    <ext:LayoutColumn ColumnWidth=".5">
                                        <ext:Panel ID="Panel34" runat="server" Border="false" BodyStyle="padding:10px;">
                                            <Body>
                        ...
                        <ext:Panel ID="Panel47" runat="server" Border="false">
                            <Body>
                                <ext:FormLayout ID="FormLayout25" runat="server" LabelWidth="500">
                                    <ext:Anchor>
                                        <ext:Label ID="lbQuota" runat="server" FieldLabel="Purchase Quota (CNY, exclude VAT)">
                                        </ext:Label>
                                    </ext:Anchor>
                                </ext:FormLayout>
                            </Body>
                        ...
                        <ext:Panel ID="Panel42" runat="server">
                            <Body>
                                <ext:ColumnLayout ID="ColumnLayout15" runat="server">
                                    <ext:LayoutColumn ColumnWidth=".5">
                                        <ext:Panel ID="Panel43" runat="server" Border="false" BodyStyle="padding:10px;">
                                            <Body>
                                                ...
                                                <ext:FormLayout ID="FormLayout2" runat="server">
                                                    ...
                                                    <ext:Anchor Horizontal="95%">
                                                        <ext:GridPanel ID="gpHospitalProductOld" runat="server" StoreID="AOPHopsptalProductOld"
                                                            Hidden="true" Border="true" Icon="Lorry" StripeRows="true"  Title="Original Agreement Term"
                                                            AutoHeight="true">
        ...
        <ext:Panel ID="Panel31" runat="server" Header="true" Title="For National Channel Manager:   Please Complete Section 4 - 6"
            ...
            <Body>
                ...
                <%-- <ext:Panel ID="Panel27" runat="server" AutoHeight="true" FormGroup="true" BodyBorder="true"
                    Title="6. IAF Package Preparations">
                    <Body>
                                        ...
                                        <ext:Panel ID="Panel29" runat="server" Border="false">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout13" runat="server" LabelWidth="450">
                                                    <ext:Anchor>
                                                        <ext:RadioGroup ID="rgIAF" Width="200" runat="server" FieldLabel=" Have you consolidated Dealer Renewal IAF and attached it to this form"
                                                            LabelSeparator="?">
                                                            <Items>
                                                                <ext:Radio ID="radioIAFYes" runat="server" BoxLabel="Yes" Checked="false" ReadOnly="true" />
                                                                <ext:Radio ID="radioIAFNo" runat="server" BoxLabel="No" Checked="false" ReadOnly="true" />
                                                            </Items>
                                                        </ext:RadioGroup>
                                                    </ext:Anchor>
                                                </ext:FormLayout>
