...
{
    [AjaxMethodProxyID(IDMode = AjaxMethodProxyIDMode.Alias, Alias = "ConsignmentCfnSetDialog")]
    public partial class ConsignmentCfnSetDialog :BaseUserControl
    {
        ...
        public void DoAddCfnSet(string Param)
        {
            ...
            (new ConsignmentMasterBLL ()).AddCfnSet(new Guid(this.hidHeaderId.Text),Param.Substring(0, Param.Length - 1), "", out rtnVal, out rtnMsg);
