<%@ Page Title="其他出入库-寄售仓库" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="InventoryAdjustConsignment.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Inventory.InventoryAdjustConsignment" %>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field demo-section k-content">
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/InventoryAdjustConsignment.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            InventoryAdjustConsignment.Init();
        });
    </script>
</asp:Content>
