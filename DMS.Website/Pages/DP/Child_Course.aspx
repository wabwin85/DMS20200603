<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Child_Course.aspx.cs" Inherits="DMS.Website.Pages.DP.Child_Course" %>
...
<body>
    ...
    <ext:Store ID="Store_Course" runat="server" UseIdConfirmation="true" OnRefreshData="Course_RefershData"
        AutoLoad="true">
    ...
    <ext:Store ID="StoreCourseType" runat="server" AutoLoad="true" UseIdConfirmation="true"
        OnRefreshData="Store_CourseTypeRefresh">
        <Proxy>
            <ext:DataSourceProxy />
        </Proxy>
        <Reader>
    ...
    <ext:TabPanel ID="TabPanel1" runat="server" Height="450" Border="false">
        <Tabs>
            <ext:Tab ID="Tab1" Hidden="true" runat="server" Title="培训记录" Border="false" BodyStyle="background-color: #D9E7F8;">
                <Body>
                                        ...
                                        <ext:Panel ID="plSearch" runat="server" Header="false" Frame="true" AutoHeight="true"
                                                        ...
                                                        <ext:Panel ID="Panel16" runat="server" Border="false">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout4" runat="server" LabelAlign="Left" LabelWidth="110">
                                                                    <ext:Anchor>
                                                                        <ext:TextField ID="tfBegin" runat="server" FieldLabel="起始培训时间" Width="200" />
                                                                    </ext:Anchor>
                                                                    <ext:Anchor>
                                                                        <ext:TextField ID="tfName" runat="server" FieldLabel="课程名称" Width="200" />
                                                                    </ext:Anchor>
                                                                </ext:FormLayout>
                                                            </Body>
                                                        </ext:Panel>
                                                        ...
                                                        <ext:Panel ID="Panel1" runat="server" Border="false">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="110">
                                                                    <ext:Anchor>
                                                                        <ext:TextField ID="tfEnd" runat="server" FieldLabel="结束培训时间" Width="200" />
                                                                    </ext:Anchor>
                                                                    <ext:Anchor>
                                                                        <ext:ComboBox ID="cbDep" runat="server" TypeAhead="true" Mode="Local" ForceSelection="true" Width="200"
                                                                            FieldLabel="培训所属部门" TriggerAction="All" ValueField="Type" DisplayField="Type"
                                                                            StoreID="StoreCourseType">
                                                                            <Triggers>
                                            ...
                                            <Buttons>
                                                <ext:Button ID="btnSearch" Text="查询" runat="server" Icon="ArrowRefresh" IDMode="Legacy">
                                                    <Listeners>
                                                        <Click Handler="#{GridPanel_Course}.reload();" />
                                                    </Listeners>
                                                </ext:Button>
                                            </Buttons>
                                        </ext:Panel>
                                        ...
                                        <ext:Panel runat="server" ID="ctl46" Border="false" Frame="false">
                                            <Body>
                                                <ext:FitLayout ID="FitLayout9" runat="server">
                                                    <ext:GridPanel ID="GridPanel_Course" runat="server" Title="查询结果" Header="false" StoreID="Store_Course"
                                                        Border="false">
                                                        <ColumnModel ID="ColumnModel9" runat="server">
                                                            <Columns>
                                                                <ext:Column ColumnID="Column1" DataIndex="Column1" Header="课程名称" Width="200">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column2" DataIndex="Column2" Header="培训时间">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column3" DataIndex="Column3" Header="培训地点" Width="250">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column4" DataIndex="Column4" Header="培训所属部门">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column5" DataIndex="Column5" Header="参加人员">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column6" DataIndex="Column6" Header="培训结果">
                                                                </ext:Column>
                                                                <ext:Column ColumnID="Column7" DataIndex="Column7" Header="备注" Width="200">
                                                                </ext:Column>
                                                            </Columns>
                                                        </ColumnModel>
                                                        <SelectionModel>
