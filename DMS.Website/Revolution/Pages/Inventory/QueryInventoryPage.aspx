<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="QueryInventoryPage.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Inventory.QueryInventoryPage" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/QueryInventoryPage.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            QueryInventoryPage.Init();
        });
    </script>
</asp:Content>
