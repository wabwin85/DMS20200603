USE [GenesisDMS_PRD]
GO
/****** Object:  StoredProcedure [Workflow].[Proc_Contract_AppointmentLp_GetHtmlData]    Script Date: 2019/12/10 11:16:13 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT 'Contract_AppointmentLp' AS TemplateName,
	       'Main,Candidate,Documents,Competency,Proposals,Justification,PreContract,Quota,Service,CrossBu,SameDealer,FormerDealer,AssessmentDealer,Cfda,Display,DDReport,TrainInfo' AS 
	       TableNames
