...
/****** Object:  StoredProcedure [Workflow].[Proc_Contract_Renewal_GetFormData]    Script Date: 2019/11/21 19:37:59 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [Workflow].[Proc_Contract_Renewal_GetFormData]
...
BEGIN
	...
	--       [Contract].RenewalProposals Proposals
	...
	Begin
		SELECT @RequestNo fd_contract_number,
			   ...
			   @DealerType +'合同续约' fd_contract_type,
