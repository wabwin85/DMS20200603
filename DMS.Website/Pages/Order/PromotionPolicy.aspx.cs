...
namespace DMS.Website.Pages.Order
{
    ...
    public partial class PromotionPolicy : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && !Ext.IsAjaxRequest)
            {
                ...
                if (IsDealer)
                {
                    this.GridPanel1.ColumnModel.SetEditable(13, false);
                    this.GridPanel1.ColumnModel.SetEditable(12, false);
                ...
                {
                    //this.GridPanel1.ColumnModel.SetEditable(13, true);
                    //this.GridPanel1.ColumnModel.SetEditable(12, true);
                    this.GridPanel1.ColumnModel.SetEditable(13, false);
                    this.GridPanel1.ColumnModel.SetEditable(12, false);
                }
        ...
        public void ResultStore_RefreshData(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            DataSet ds = business.QueryPromotionPolicy(param, (e.Start == -1 ? 0 : e.Start), (e.Limit == -1 ? this.PageToolBar2.PageSize : e.Limit), out totalCount);
        ...
        private DataSet GetPolicyInfo()
        {
            ...
            DataSet ds = business.ExportPromotionPolicy(param);
        ...
        public void DoYes(string qty, string remark)
        {
            ...
            business.SaveItem(adjustqty, remark, this.hiddenCurrentEditId.Text.ToString());
            this.ResultStore.DataBind();
        }
