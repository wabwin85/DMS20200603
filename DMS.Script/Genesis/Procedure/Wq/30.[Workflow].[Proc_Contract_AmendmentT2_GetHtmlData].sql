...
/****** Object:  StoredProcedure [Workflow].[Proc_Contract_AmendmentT2_GetHtmlData]    Script Date: 2019/11/22 14:30:37 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [Workflow].[Proc_Contract_AmendmentT2_GetHtmlData]
...
BEGIN
	...
	SET @CurrentHospitalUrl += '&PropertyType=0' --+ CASE WHEN @IsLP= '0' THEN '0'ELSE '2'END;
