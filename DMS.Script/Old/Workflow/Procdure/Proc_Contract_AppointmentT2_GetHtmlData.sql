DROP PROCEDURE [Workflow].[Proc_Contract_AppointmentT2_GetHtmlData]
GO


CREATE PROCEDURE [Workflow].[Proc_Contract_AppointmentT2_GetHtmlData]
	@InstanceId UNIQUEIDENTIFIER
AS
BEGIN
	--Template & Tables
	SELECT 'Contract_AppointmentT2' AS TemplateName,
	       'Main,Candidate,Documents,Competency,Proposals,CrossBu,SameDealer,FormerDealer,AssessmentDealer,Cfda,Display' AS 
	       TableNames
