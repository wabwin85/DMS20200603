<%@ Page Title="平台及一级经销商那订单申请" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="OrderCfnDialogLPPROPicker.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Order.OrderCfnDialogLPPROPicker" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/OrderCfnDialogLPPROPicker.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            OrderCfnDialogLPPROPicker.Init();
        });
    </script>
</asp:Content>
