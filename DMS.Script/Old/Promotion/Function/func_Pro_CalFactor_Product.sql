DROP FUNCTION [Promotion].[func_Pro_CalFactor_Product]
GO
...
/**********************************************
 ...
 1.创建 2015-08-28
**********************************************/
CREATE FUNCTION [Promotion].[func_Pro_CalFactor_Product](
	@PolicyFactorId INT
	)
RETURNS @temp TABLE
	(
...
BEGIN
	...
	SET @iCURSOR = CURSOR FOR SELECT B.ConditionId,B.ConditionValue,B.OperTag 
		...
		WHERE A.PolicyFactorId = B.PolicyFactorId AND A.PolicyFactorId = @PolicyFactorId 
	OPEN @iCURSOR 	
