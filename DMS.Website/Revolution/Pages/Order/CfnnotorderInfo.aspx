<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="CfnnotorderInfo.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Order.CfnnotorderInfo" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/CfnnotorderInfo.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            CfnnotorderInfo.Init();
        });
    </script>
</asp:Content>
