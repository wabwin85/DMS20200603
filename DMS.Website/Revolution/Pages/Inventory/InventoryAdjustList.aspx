<%@ Page Title="其他出入库-普通仓库" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="InventoryAdjustList.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Inventory.InventoryAdjustList" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/InventoryAdjustList.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            InventoryAdjustList.Init();
        });
    </script>
</asp:Content>
