...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            SET @MailBody
                = '尊敬的经销商同事您好，<br/> 贵司新经销商合同已经被申请，请及时进入经销商管理系统（DMS）完成：<br/><br/>1. 合规培训 <br/>2. 问卷调查。<br/><br/>若合同审批完，您还未完成培训和调研，贵公司合同不能生效！ <br/><br/>备注：请尽量使用谷歌浏览器参加培训<br><br>蓝威DMS系统<br>――――――――――――――――――――――――<br>此邮件为系统自动发送，请勿回复！<br>谢谢！';
        END;
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            SET @MailBody
                = '尊敬的经销商同事您好，<br/> 贵司新经销商合同已经被申请，请及时进入经销商管理系统（DMS）完成：<br/><br/>1. 合规培训 <br/>2. 问卷调查。<br/><br/>若合同审批完，您还未完成培训和调研，贵公司合同不能生效！ <br/><br/>备注：请尽量使用谷歌浏览器参加培训<br><br蓝威DMS系统<br>――――――――――――――――――――――――<br>此邮件为系统自动发送，请勿回复！<br>谢谢！';
        END;
