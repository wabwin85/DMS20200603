var ShipmentListInfoForBSC = {};

ShipmentListInfoForBSC = function () {
    var that = {};
    ...
    that.Init = function () {
        ...
        var vWinShipmentNbr = {};
        data.WinShipmentNbr = Common.GetUrlParam('ShipmentNbr');
        vWinShipmentNbr.WinShipmentNbr = data.WinShipmentNbr;
        ...
        $.ajax({
            type: "POST",
            url: "ShipmentListInfoForBSC.aspx/InitDetailWinForBSC",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: kendo.stringify(vWinShipmentNbr),
            success: function (result) {
                var model = $.parseJSON(result.d);
                //按钮
                ...
                */
                ...
                $('#WinSLShipmentDate').FrameTextBox({
                    value: new Date(model.WinSLShipmentDate).format("yyyy-MM-dd"),
                    readonly: true
                });
                ...
                //});
                $('#WinSLInvoiceDate').FrameTextBox({
                    value: new Date(model.WinSLInvoiceDate).format("yyyy-MM-dd"),
                    readonly: true
                });
                ...
                $("#RstWinSLAttachList").data("kendoGrid").setOptions({
                    dataSource: {
                        data: model.RstWinSLAttachList,
                        schema: {
                            model: {
                                fields: {
