<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerDeatil.aspx.cs" Inherits="DMS.Website.Pages.MasterDatas.DealerDeatil" %>
...
<body>
    ...
    <script type="text/javascript">
        function prepareCommand(grid, toolbar, rowIndex, record) {
            ...
            if (contextUserId.getValue().toLowerCase() == record.data.UploadUser.toLowerCase()) {
    ...
    <ext:Store ID="AttachmentStore" runat="server" UseIdConfirmation="true" AutoLoad="true"
        OnRefreshData="Store_RefreshAttachment">
        <Proxy>
            <ext:DataSourceProxy />
        </Proxy>
        <Reader>
            ...
            <Body>
                <ext:FitLayout ID="FitLayout1" runat="server">
                    <ext:TabPanel ID="TabPanelDeatil" runat="server" ActiveTabIndex="0" >
                            ...
                            <ext:Toolbar ID="Toolbar1" runat="server">
                                <Items>
                                    ...
                                    <ext:Button ID="btnCancel" runat="server" Text="返回" Icon="Delete">
                                        <Listeners>
                                            <Click Handler="window.location.href('DealerMaintainList.aspx');" />
                                        </Listeners>
                                    </ext:Button>
                                </Items>
                            </ext:Toolbar>
                        ...
                        <Tabs>
                            <ext:Tab ID="tabForm1" runat="server" Title="附件信息" Icon="ApplicationEdit" AutoShow="true">
                                <Body>
                                    <ext:BorderLayout ID="BorderLayout1" runat="server">
                                        ...
                                        <Center>
                                            <ext:Panel runat="server" ID="Panel3" Border="false" Frame="true">
                                                <Body>
                                                    <ext:FitLayout ID="FitLayout4" runat="server">
                                                        <ext:GridPanel ID="gpAttachment" runat="server" Title="附件" StoreID="AttachmentStore"
