...
/****** Object:  UserDefinedFunction [dbo].[fn_GetCfnPriceByDealer]    Script Date: 2019/10/21 13:44:09 ******/
SET ANSI_NULLS ON
GO
...
CREATE Function [dbo].[fn_GetCfnPriceByDealer] 
	(@DealerId uniqueidentifier,                          --经销商
