<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="ShipmentListInfoForBSC.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Shipment.ShipmentListInfoForBSC" %>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="hidden" id="WinShipmentNbr" class="FrameControl" />
                        ...
                        <div class="col-xs-12 DetailTab">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <div style="float:right;display:none"><a id="BtnSLAddAttach"></a></div>
                                </div>
...
<asp:Content ID="ContentFoot" ContentPlaceHolderID="FootContent" runat="server">
    <div class="foot-bar col-buttom" style="display:none;">
        <a id="BtnWinDraft"></a>
        <a id="BtnWinDelete"></a>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript" src="Script/ShipmentListInfoForBSC.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ShipmentListInfoForBSC.Init();
        });
    </script>
</asp:Content>
