<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerAOPReport.aspx.cs" Inherits="DMS.Website.Pages.Report.DealerAOPReport" %>
                                        ...
                                        <Body>
                                            <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="80">
                                                <ext:Anchor>
                                                    ...
                                                    EmptyText="<%$ Resources: Panel1.FormLayout1.cbCOP.EmptyText %>" 
                                                    Width="150" 
                                                    Editable="false"
                                                    TypeAhead="true" 
                                                    ...
                                                    FieldLabel="<%$ Resources: Panel1.FormLayout1.cbCOP.FieldLabel %>"                                                    
                                                    >
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" Qtip="<%$ Resources: Panel1.FormLayout1.cbCOP.FieldTrigger.Qtip %>" />
                                                    </Triggers>
                                                    <Listeners>
                                                        <TriggerClick Handler="this.clearValue();" />
                                                    </Listeners>
