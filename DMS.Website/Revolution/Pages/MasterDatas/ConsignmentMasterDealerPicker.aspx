<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="ConsignmentMasterDealerPicker.aspx.cs" Inherits="DMS.Website.Revolution.Pages.MasterDatas.ConsignmentMasterDealerPicker" %>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="hidden" id="DivisionCode" class="FrameControl" />
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group condition condition-upn">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="FilterDealer" class="FrameControl"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group condition condition-upn">
                                    <div class="col-xs-4 col-label">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group condition condition-upn">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryBuName" class="FrameControl"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/ConsignmentMasterDealerPicker.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ConsignmentMasterDealerPicker.Init();
        });
    </script>
</asp:Content>
