<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="InventoryAdjustList_New.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Inventory.InventoryAdjustList_New" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript" src="Script/InventoryAdjustList_New.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            InventoryAdjustList_New.Init();
        });
    </script>
</asp:Content>
