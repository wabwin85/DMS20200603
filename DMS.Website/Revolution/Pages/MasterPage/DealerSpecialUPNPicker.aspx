...
<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="DealerSpecialUPNPicker.aspx.cs" Inherits="DMS.Website.Revolution.Pages.MasterPage.DealerSpecialUPNPicker" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/DealerSpecialUPNPicker.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            DealerSpecialUPNPicker.Init();
        });
    </script>
</asp:Content>
