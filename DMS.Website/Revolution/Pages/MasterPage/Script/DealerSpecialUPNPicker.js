var DealerSpecialUPNPicker = {};

DealerSpecialUPNPicker = function () {
    var that = {};

    var business = 'MasterPage.DealerSpecialUPNPicker';
    var pickedList = [];
        ...
        $("#RstResultList").kendoGrid({
            ...
            columns: [
                 ...
                 },
                {
                 ...
                 {
                     field: "CFN_EnglishName", title: "产品英文名", width: 'auto',
                ...
                {
                    field: "PMA_ConvertFactor", title: "规格", width: '50px',
                    headerAttributes: { "class": "text-center text-bold", "title": "规格" }
                },
                {
                    field: "CFN_Property3", title: "单位", width: '50px',
    ...
    var addItem = function (data) {
        if (!isExists(data)) {
            //pickedList.push({
            //    CFN_ID: data.CFN_ID,
            //    CFN_Property1: data.CFN_Property1,
            //    PMA_ConvertFactor: data.PMA_ConvertFactor,
            //    CFN_Property3: data.CFN_Property3,
            //    CFN_EnglishName: data.CFN_EnglishName,
            //    CFN_ChineseName: data.CFN_ChineseName,
            //});
            if (pickedList.length == 0) {
