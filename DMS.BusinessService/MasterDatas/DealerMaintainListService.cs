...
{
    public class DealerMaintainListService : ABaseQueryService, IDealerFilterFac, IQueryExport
    {
        #region Ajax Method
        ...
        public DealerMaintainListVO Init(DealerMaintainListVO model)
        {
            try
            {
        ...
        public string Query(DealerMaintainListVO model)
        {
            try
            {
                ...
                model.RstResultList = JsonHelper.DataTableToArrayList(dao.QueryForDealerMaster(param, start, model.PageSize, out totalCount).Tables[0]);
        ...
        public string QueryDealerContactInfo(DealerMaintainListVO model)
        {
            try
            {
        ...
        public string QueryAttachInfo(DealerMaintainListVO model)
        {
            try
            {
        ...
        public DealerMaintainListVO InitLCDetailWin(DealerMaintainListVO model)
        {
            try
            {
                //初始窗体部分
        ...
        public void Export(NameValueCollection Parameters, string DownloadCookie)
        {
            ...
            else if (Parameters["DealerListExportType"].ToSafeString() == "ExportByAuthorizeHos")
            {
                Hashtable param = new Hashtable();
                DealerMasterLicenseDao dao = new DealerMasterLicenseDao();
                if (!string.IsNullOrEmpty(Parameters["QryDealer"].ToSafeString()))
                ...
                DataSet ds = dao.SelectDealerAuthHospitalExport(param);
                ExportFile(ds, DownloadCookie);
            }
