<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmenCfnSet.ascx.cs" Inherits="DMS.Website.Controls.ConsignmenCfnSet" %>
    ...
    var addCfnSet = function(grid) {
        ...
        if (list.length > 0) {
            Ext.Msg.confirm('Message', '确定添加?',
                function(e) {
                    if (e == 'yes') {
                        Coolite.AjaxMethods.ConsignmenCfnSet.DoAddCfnSet(list,
                        {
                            success: function() {
