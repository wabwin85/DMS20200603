DROP VIEW [interface].[V_I_EW_CRMDataForComplain_WithQR]
GO


CREATE VIEW [interface].[V_I_EW_CRMDataForComplain_WithQR]
AS
SELECT WHM_Name
	,WHM_ID
	,whm_type
...
WHERE DMA_ID = WHM_DMA_ID AND WHM_ID = INV_WHM_ID AND INV_PMA_ID = PMA_ID AND INV_ID = LOT_INV_ID AND LOT_LTM_ID = LTM_ID AND LOT_OnHandQty <> 0 AND CFN_ID = PMA_CFN_ID AND CFN_ProductLine_BUM_ID = View_ProductLine.Id AND WHM_Type <> 'SystemHold' AND CFN_ProductLine_BUM_ID = '97a4e135-74c7-4802-af23-9d6d00fcb2cc'
