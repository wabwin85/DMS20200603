...
namespace DMS.Model
{
	...
	/// </summary>
	[Serializable]
	public class PurchaseOrderInterface : BaseModel
	{
		...
		/// <summary>
		/// 处理状态<br/>   待处理Pending<br/>   处理中Processing<br/>   处理成功Success<br/>   处理失败Failure
		/// </summary>		
