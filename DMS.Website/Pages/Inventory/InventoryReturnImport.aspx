<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryReturnImport.aspx.cs" Inherits="DMS.Website.Pages.Inventory.InventoryReturnImport" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var editControls = [
                          ...
                          { name: 'PurchaseOrderNbr', field: {xtype:"textfield",width:100,maxLength:50,allowBlank:false} },
        ...
        var rowCommand = function(command, record, row){
            if (command == "Edit"){
                ...
                var tbPurchaseOrderNbr = Ext.getCmp('tbPurchaseOrderNbr');
            ...
            <Reader>
                <ext:JsonReader ReaderID="Id">
                    <Fields>
                        ...
                        <ext:RecordField Name="PurchaseOrderNbrErrMsg" />
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_Return.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: GridPanel3.Title %>" StoreID="ResultStore" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="PurchaseOrderNbr" DataIndex="PurchaseOrderNbr" Header="<%$ Resources: GridPanel3.ColumnModel3.PurchaseOrderNbr.Header  %>" Sortable="false" Width="200px">
                                                <Renderer Fn="renderData" />
                                                </ext:Column>
