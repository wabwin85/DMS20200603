<%@ Page Title="经销商收货列表" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="POReceiptList.aspx.cs" Inherits="DMS.Website.Revolution.Pages.POReceipt.POReceiptList" %>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <%-- 禁用div,否则会出现禁用输入时，点击选择无效bug--%>
                                        <%--    <div id="QryBeginDate" class="FrameControl datecontrol"></div>--%>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryDeliveryOrderNo" class="FrameControl"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    <div class="col-xs-4 col-label">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryPurchaseOrderNo" class="FrameControl"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    <div class="col-xs-4 col-label">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryERPNbr" class="FrameControl"></div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    <div class="col-xs-4 col-label">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryERPLineNbr" class="FrameControl"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-buttom" id="PnlButton">
                                    <a id="BtnDeliveryImport"></a>
                                    <a id="BtnVRDeliveryImport"></a>
                                    <a id="BtnRLDImport"></a>
                                    <%--  <a id="BtnNew"></a>--%>
                                    <a id="BtnQuery"></a>
                                    <a id="BtnExport"></a>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/POReceiptList.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
