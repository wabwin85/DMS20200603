<%@ Page Title="短期寄售规则维护" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="ConsignmentMasterList.aspx.cs" Inherits="DMS.Website.Revolution.Pages.MasterDatas.ConsignmentMasterList" %>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-group">
                                    ...
                                    <div class="col-xs-8 col-field">
                                        <div id="QryConsignmentName" class="FrameControl"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/ConsignmentMasterList.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            ConsignmentMasterList.Init();
        });
    </script>
</asp:Content>
