<%@ Page Title="RLD导入" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="POReceiPtImport.aspx.cs" Inherits="DMS.Website.Revolution.Pages.POReceipt.POReceiPtImport" %>
...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
    <input type="hidden" id="batchNumber" class="FrameControl" />
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/POReceiPtImport.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            POReceiPtImport.Init();
        });
    </script>
</asp:Content>
