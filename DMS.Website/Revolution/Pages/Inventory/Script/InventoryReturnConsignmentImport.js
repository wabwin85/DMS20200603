var InventoryReturnConsignmentImport = {};

InventoryReturnImport = function () {
    var that = {};

    var business = 'Inventory.InventoryReturnConsignmentImport';
    var IMPORT_TYPE = 'InventoryReturnConsignmentImport';
    ...
    var createResultList = function () {
        $("#ImportErrorGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "LineNbr", title: "二维码", width: '100px', editable: true,
                ...
                {
                    field: "PurchaseOrderNbr", title: "关联订单号", width: '100px', editable: true,
                    headerAttributes: { "class": "text-center text-bold", "title": "关联订单号" }
                },
               {
