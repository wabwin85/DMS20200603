<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="ProductOperationLog.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Report.ProductOperationLog" %>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-buttom" id="PnlButton">
                                    <a id="BtnQuery"></a>
                                    <a id="BtnExportProductOperationLog"></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/ProductOperationLog.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(function () {
            ProductOperationLog.Init();
        });
    </script>
</asp:Content>
