<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageKendo/Site.Master" AutoEventWireup="true" CodeBehind="T1Edit.aspx.cs" Inherits="DMS.Website.Pages.ContractKendo.LPTOne.T1Edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript" src="../script/T1Edit.js?v=1.1"></script>
    <script>
