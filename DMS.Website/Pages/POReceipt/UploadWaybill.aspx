<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadWaybill.aspx.cs"
    Inherits="DMS.Website.Pages.POReceipt.UploadWaybill" %>
                        ...
                        <ext:FormPanel ID="BasicForm" runat="server" Width="500" Frame="true" Title="<%$ Resources: BasicForm.Title %>"
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="DownloadButton" runat="server" Text="<%$ Resources: DownloadButton.Text %>">
                                    <Listeners>
                                        <Click Handler="window.open('../../Upload/ExcelTemplate/Template_Waybill.xls')" />
                                    </Listeners>
                                </ext:Button>
                            </Buttons>
                        </ext:FormPanel>
                                    ...
                                    <ext:GridPanel ID="GridPanel3" runat="server" Title="<%$ Resources: GridPanel3.Title %>" StoreID="Store1" Border="false"
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ColumnID="SapDeliveryNo" DataIndex="SapDeliveryNo" Header="<%$ Resources: GridPanel3.ColumnModel3.SapDeliveryNo.Header %>">
                                                </ext:Column>
                                                <ext:Column ColumnID="ShippingDate" DataIndex="ShippingDate" Header="<%$ Resources: GridPanel3.ColumnModel3.ShippingDate.Header %>">
                                                </ext:Column>
                                                ...
                                                <ext:Column ColumnID="ShipType" DataIndex="ShipType" Header="<%$ Resources: GridPanel3.ColumnModel3.ShipType.Header %>">
                                                </ext:Column>
