...
Values('Menu',2,'医院标准指标维护',68,0,'~/Revolution/Pages/MasterDatas/HospitalBaseAop.aspx',
1,'M2_AOPHospitalReferenceManage',40,'admin',GetDate())
...
Values(newid(),(Select PowerKey From lafite_sitemap WHERE MenuType='Menu' AND MenuTitle='医院标准指标维护'),
'医院标准指标维护','',0,'','Menu',1,'4028931b0f0fc135010f0fc1356a0001',0,'admin',GetDate(),
'admin',GetDate())
...
Values(newid(),'','','医院标准指标维护',1,'','4028931b0f0fc135010f0fc1356a0001',0,
...
Values(newid(),(Select id from lafite_STRATEGY where strategy_name='医院标准指标维护'),
'Function',(select id from Lafite_Function where Function_Name='医院标准指标维护'),0,
...
,'STRATEGY',(Select id from lafite_STRATEGY where strategy_name='医院标准指标维护'),
