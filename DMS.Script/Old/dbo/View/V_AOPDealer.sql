DROP VIEW [dbo].[V_AOPDealer]
GO

CREATE VIEW [dbo].[V_AOPDealer]
AS
select AOPD_Dealer_DMA_ID,AOPD_ProductLine_BUM_ID,AOPD_CC_ID,AOPD_Market_Type,AOPD_Year,
			 sum(case
       ...
       from AOPDealer(nolock)
       group by AOPD_Dealer_DMA_ID,AOPD_ProductLine_BUM_ID,AOPD_CC_ID,AOPD_Market_Type,AOPD_Year
GO
