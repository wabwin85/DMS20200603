<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractDealerHospitalProductAOPListAmendment.aspx.cs"
    Inherits="DMS.Website.Pages.Contract.ContractDealerHospitalProductAOPListAmendment" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .x-grid3-td-RefQ2, .x-grid3-td-Q2, .x-grid3-td-Q4, .x-grid3-td-RefQ4, .x-grid3-td-AOPD_Amount_4, .x-grid3-td-AOPD_Amount_5, .x-grid3-td-AOPD_Amount_6, .x-grid3-td-AOPD_Amount_10, .x-grid3-td-AOPD_Amount_11, .x-grid3-td-AOPD_Amount_12, .x-grid3-td-Q4, .x-grid3-td-RefQ4, .x-grid3-td-Unit4, .x-grid3-td-Unit5, .x-grid3-td-Unit6, .x-grid3-td-Unit10, .x-grid3-td-Unit11, .x-grid3-td-Unit12
        {
            background-color: #EDEEF0;
        }
        .x-grid3-td-RefYear, .x-grid3-td-UnitY, .x-grid3-td-AOPD_Amount_Y, .x-grid3-td-Amount_Y
        {
...
<body>
    ...
    <script type="text/javascript">
        ...
        var SubmitPriceClick = function(tree) {
            ...
            Coolite.AjaxMethods.SaveProductPrice(Nodesid.toString(), { success: function(result) {if(result==''){ Ext.getCmp('<%=this.txtGPHospitalUpdate.ClientID%>').reload(); Ext.getCmp('<%=this.GridPanelAOPStore.ClientID%>').reload();Ext.getCmp('<%=this.GridDealerAop.ClientID%>').reload();
        ...
        {
            var TabPanel = <%= TabPanelDeatil.ClientID %>;
            var TabPrice = <%= TabProductPrice.ClientID %>;
            TabPrice.disabled=false;
            TabPanel.setActiveTab(TabPrice);
        }
                                    ...
                                    <ext:BorderLayout ID="BorderLayout3" runat="server">
                                        ...
                                        <Center MarginsSummary="0 5 5 5">
                                            <ext:Panel runat="server" ID="Panel11" Border="false" Frame="true" Title="第二步：选择产品价格"
                                                ...
                                                <Buttons>
                                                    <ext:Button ID="Button8" runat="server" Text="提交，刷新指标" Icon="Disk" CommandArgument=""
                                ...
                                <Body>
                                    <ext:BorderLayout ID="BorderLayout2" runat="server">
                                                        ...
                                                        <ext:GridPanel ID="GridPanelAOPStore" runat="server" Header="false" StoreID="AOPStore"
                                                            ...
                                                            <ColumnModel ID="ColumnModel1" runat="server">
                                                                <Columns>
                                                                    ...
                                                                    <ext:Column ColumnID="RefYear" DataIndex="RefYear" Header="合计<br/>标准/历史" Width="60"
                                                                        Align="Center">
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit1" DataIndex="RefUnit1" Header="一月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                    </ext:Column>
                                                                    <ext:Column ColumnID="Unit1" DataIndex="Unit1" Header="一月" Width="50" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    <ext:Column ColumnID="RefUnit2" DataIndex="RefUnit2" Header="二月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit3" DataIndex="RefUnit3" Header="三月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    <ext:Column ColumnID="Unit3" DataIndex="Unit3" Header="三月" Width="50" Align="Center">
                                                                    </ext:Column>
                                                                    <ext:Column ColumnID="RefUnit4" DataIndex="RefUnit4" Header="四月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit5" DataIndex="RefUnit5" Header="五月<br/>50/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit6" DataIndex="RefUnit6" Header="六月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit7" DataIndex="RefUnit7" Header="七月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit8" DataIndex="RefUnit8" Header="八月<br/>标准/历史" Width="45"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit9" DataIndex="RefUnit9" Header="九月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit10" DataIndex="RefUnit10" Header="十月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit11" DataIndex="RefUnit11" Header="十一月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                                                    ...
                                                                    <ext:Column ColumnID="RefUnit12" DataIndex="RefUnit12" Header="十二月<br/>标准/历史" Width="55"
                                                                        Hidden="true" Align="Center">
                                                                        <Renderer Fn="Ext.util.Format.numberRenderer('0.0')" />
                                                                    </ext:Column>
                                        ...
                                        <South Collapsible="True" MarginsSummary="0 5 0 5">
                                            <ext:Panel runat="server" ID="PanelDealerAop" Border="false" Frame="true" Title="第三步：维护经销商医院指标: <img src='/resources/images/icons/exclamation.png' > </img> 经销商指标小于医院指标或者大于医院指标的20%(不含税指标)"
                                                Icon="HouseKey" Height="200" ButtonAlign="Left">
                                                <Body>
                                                        ...
                                                        <ext:GridPanel ID="GridDealerAop" runat="server" Header="false" StoreID="AOPDealerStore"
                                                            ...
                                                            <ColumnModel ID="ColumnModel2" runat="server">
                                                                <Columns>
                                                                    ...
                                                                    <ext:Column ColumnID="Amount_Y" DataIndex="Amount_Y" Header="合计" Width="70" Align="Center">
                                                                    </ext:Column>
                            ...
                            <Body>
                                <ext:BorderLayout ID="BorderLayout5" runat="server">
                                                ...
                                                <ext:ColumnLayout ID="ColumnLayout5" runat="server" FitHeight="true">
                                                    <ext:LayoutColumn ColumnWidth="0.4">
                                                        <ext:Panel ID="Panel7" runat="server" Frame="false" Header="true">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout7" runat="server" LabelWidth="65">
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:Label runat="server" ID="Label4" Text="经销商当前指标" FieldLabel="月份">
                                                                        </ext:Label>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_1" runat="server" FieldLabel="1月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_2" runat="server" FieldLabel="2月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_3" runat="server" FieldLabel="3月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_4" runat="server" FieldLabel="4月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_5" runat="server" FieldLabel="5月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_6" runat="server" FieldLabel="6月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_7" runat="server" FieldLabel="7月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_8" runat="server" FieldLabel="8月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_9" runat="server" FieldLabel="9月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_10" runat="server" FieldLabel="10月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_11" runat="server" FieldLabel="11月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtFormalDealerAmount_12" runat="server" FieldLabel="12月" Enabled="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                </ext:FormLayout>
                                                            </Body>
                                                    ...
                                                    <ext:LayoutColumn ColumnWidth="0.3">
                                                        <ext:Panel ID="Panel14" runat="server" Frame="false" Header="true">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout10" runat="server" LabelWidth="10">
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:Label runat="server" ID="Label2" Text="医院商业指标" LabelSeparator="">
                                                                        </ext:Label>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_1" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_2" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_3" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_4" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_5" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_6" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_7" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_8" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_9" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_10" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_11" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="90%">
                                                                        <ext:TextField ID="txtReHosAmount_12" runat="server" Enabled="false" LabelSeparator="">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                </ext:FormLayout>
                                                            </Body>
                                                    ...
                                                    <ext:LayoutColumn ColumnWidth="0.3">
                                                        <ext:Panel ID="Panel8" runat="server" Frame="false" Header="true">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout3" runat="server" LabelWidth="10">
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:Label runat="server" ID="Label1" Text="经销商修改后指标" LabelSeparator="">
                                                                        </ext:Label>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_1" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_2" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_3" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_4" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_5" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_6" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_7" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_8" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_9" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_10" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_11" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:TextField ID="txtAmount_12" runat="server" LabelSeparator="" MaskRe="/[0-9\.]/"
                                                                            Enabled="false" SelectOnFocus="false" AllowBlank="false">
                                                                        </ext:TextField>
                                                                    </ext:Anchor>
                                                                </ext:FormLayout>
                                    ...
                                    <South Collapsible="True" MarginsSummary="0 0 0 5">
                                        <ext:Panel ID="panel13" runat="server" Frame="true" AutoHeight="true" Title="经销商指标小于医院商业指标或大于医院商业指标20%原因：">
                                            <Body>
                                                <ext:FormLayout ID="FormLayout9" runat="server">
                                                    <ext:Anchor>
                                                        <ext:TextArea ID="txtDealerAopRemark" runat="server" HideLabel="true" Width="500">
                                                        </ext:TextArea>
                                                    </ext:Anchor>
                                                </ext:FormLayout>
                                            </Body>
                                                        ...
                                                        <ext:Panel ID="Panel6" runat="server" Frame="false" Header="true">
                                                            <Body>
                                                                <ext:FormLayout ID="FormLayout6" runat="server" LabelWidth="10">
                                                                    <ext:Anchor Horizontal="100%">
                                                                        <ext:Label runat="server" ID="Label3" Text="数量" LabelSeparator="">
                                                                        </ext:Label>
                                                                    </ext:Anchor>
                                                                    <ext:Anchor Horizontal="100%">
