<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractDealerHospitalAOPList.aspx.cs"
    Inherits="DMS.Website.Pages.Contract.ContractDealerHospitalAOPList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <ext:Window ID="AOPHospitalWindow" runat="server" Icon="Group" Title="经销商医院实际指标设置"
                ...
                <Buttons>
                    ...
                    <ext:Button ID="CancelButton" runat="server" Text="关闭" Icon="Cancel">
                        <Listeners>
                            <Click Handler="#{AOPHospitalWindow}.hide(null); #{GridPanelAOPStore}.reload();#{AOPDealerStore}.reload();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
            <ext:Window ID="AOPDealerWindow" runat="server" Icon="Group" Title="经销商商业采购指标设置"
                ...
                Maximizable="true" AutoScroll="true" Draggable="false" Width="790" Modal="true"
