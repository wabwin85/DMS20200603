...
<%@ Page Title="" Language="C#" MasterPageFile="~/Revolution/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="ConsignInventoryAdjustPicker.aspx.cs" Inherits="DMS.Website.Revolution.Pages.Consign.ConsignInventoryAdjustPicker" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript" src="Script/ConsignInventoryAdjustPicker.js?v=<%=DMS.Common.SR.CONST_JAVA_SCRIPT_VERSION %>"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ConsignInventoryAdjustPicker.Init();
        });
    </script>
</asp:Content>