var DealerTransferOut = {};

DealerTransferOut = function () {
    var that = {};

    var business = 'Report.DealerTransferOut';
    ...
    that.Init = function () {
        ...
        FrameUtil.SubmitAjax({
            ...
            callback: function (model) {
                ...
                $('#BtnExportTransferOut').FrameButton({
                    text: '导出',
                    icon: 'file-excel-o',
                    onClick: function () {
                        that.ExportTransferOut();
                    }
                });                                
    ...
    var createResultList = function () {
        $("#RstResultList").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "FromDMA_ChineseName", title: "经销商名称", width: 250,
                    headerAttributes: { "class": "text-center text-bold", "title": "经销商名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "FromDMA_EnglishName", title: "经销商英文名称", width: 200,
                    headerAttributes: { "class": "text-center text-bold", "title": "经销商英文名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "FromDMA_SAP_Code", title: "ERPCode", width: 70,
                ...
                {
                    field: "TRN_TransferNumber", title: "借货出库单号", width: 150,
                    headerAttributes: { "class": "text-center text-bold", "title": "借货出库单号" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "TRN_TransferDate", title: "出库日期", width: 100,
                    headerAttributes: { "class": "text-center text-bold", "title": "出库日期" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "ToDMA_ChineseName", title: "借入经销商名称", width: 250,
                    headerAttributes: { "class": "text-center text-bold", "title": "借入经销商名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "ToDMA_EnglishName", title: "借入经销商英文名称", width: 200,
                    headerAttributes: { "class": "text-center text-bold", "title": "借入经销商英文名称" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "ToDMA_SAP_Code", title: "借入经销商ERPCode", width: 140,
                    headerAttributes: { "class": "text-center text-bold", "title": "借入经销商ERPCode" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "WHM_Name", title: "调出库", width: 250,
                    headerAttributes: { "class": "text-center text-bold", "title": "调出库" },
                    attributes: { "class": "table-td-cell" }
                },
                //{
                ...
                {
                    field: "TLT_TransferLotQty", title: "借出数量", width: 80,
                    headerAttributes: { "class": "text-center text-bold", "title": "借出数量" },
                    attributes: { "class": "table-td-cell" }
                },
                {
                    field: "TRN_StatusName", title: "是否已经被接收", width: 100,
                    headerAttributes: { "class": "text-center text-bold", "title": "是否已经被接收" },
                    attributes: { "class": "table-td-cell" }
                }
    ...
    that.ExportTransferOut = function () {
        var data = that.GetModel();

        var urlExport = Common.ExportUrl;
        urlExport = Common.UpdateUrlParams(urlExport, 'Business', business);
        urlExport = Common.UpdateUrlParams(urlExport, 'DownloadCookie', 'TransferOutExportByDealer');
        urlExport = Common.UpdateUrlParams(urlExport, 'ExportType', 'ExportTransferOut');
        ...
        startDownload(urlExport, 'TransferOutExportByDealer');
    }
