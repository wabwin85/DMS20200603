USE [GenesisDMS_Test]
GO
/****** Object:  StoredProcedure [dbo].[GC_Cache_InitDealer]    Script Date: 2019/10/9 11:18:16 ******/
SET ANSI_NULLS ON
GO
...
*/
ALTER Procedure [dbo].[GC_Cache_InitDealer]
AS
...
from DealerMaster 
where DMA_ActiveFlag = 1 and DMA_DeletedFlag = 0 and DMA_HostCompanyFlag = 0 and DMA_DealerType IN ('LP','LS')
and not exists (select 1 from Warehouse 
