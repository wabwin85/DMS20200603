...
{
    public class OrderImportService : IRequiresSessionState
    {
        private PurchaseOrderBLL business = new PurchaseOrderBLL();

        private IRoleModelContext _context = RoleModelContext.Current;
        public OrderImportVO Init(OrderImportVO model)
        {
            try
            {
        ...
        public string Query(OrderImportVO model)
        {
            try
            {
        ...
        /// <returns></returns>
        public OrderImportVO Save(OrderImportVO model)
        {
            try
            {
                model.ImportButtonDisable = true;
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public OrderImportVO Delete(OrderImportVO model)
        {
            try
            {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public OrderImportVO ImportDB(OrderImportVO model)
        {
            try
            {
